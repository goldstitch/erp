...
$data['title'] = 'Purchase Order Voucher';
...
$vrnoa = $this->orders->getMaxVrnoa('pur_order',$ordermain['company_id']) +1;
}
...
$groupBy = $_POST['groupBy'];
$name = $_POST['name'];
$sreportData = $this->orders->fetchSaleReportData($startDate,$endDate,$what,$type,$company_id,$etype,$field,$crit,$orderBy,$groupBy,$name);
$this->output
->set_content_type('application/json')
->set_output(json_encode($sreportData));
}
