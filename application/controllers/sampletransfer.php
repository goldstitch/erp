...
class Sampletransfer extends CI_Controller {
...
$data['modules'] = array('inventory/sampletransfer');
...
$data['title'] = "Sample Transfer Voucher";
$this->load->view('template/header',$data);
$this->load->view('inventory/sampletransfer',$data);
$this->load->view('template/mainnav');
$this->load->view('template/footer',$data);
}
...
public function samplereceive() {
    ...
    $data['no'] =$this->users->unposttransfer();
    $data['modules'] = array('inventory/samplereceive');
    $data['receivers'] = $this->purchases->fetchByCol('received_by');
    $data['approvedby'] = $this->purchases->fetchByCol('approved_by');
    $data['preparedby'] = $this->purchases->fetchByCol('prepared_by');
    $data['departments'] = $this->departments->fetchAllDepartments();
    ...
    $data['title'] = "Stock Receive Voucher";
    $this->load->view('template/header',$data);
    $this->load->view('inventory/samplereceive',$data);
    $this->load->view('template/mainnav');
    $this->load->view('template/footer',$data);
    }
...
$result = $this->purchases->getMaxVrno('sample_issue',$company_id) +1;
$this->output->set_content_type('application/json')->set_output(json_encode($result));
}
public function getMaxVrnoa_issue() {
$company_id = $_POST['company_id'];
$result = $this->purchases->getMaxVrnoa('sample_issue',$company_id) +1;
$this->output->set_content_type('application/json')->set_output(json_encode($result));
}

public function getMaxVrno_receive() {
$company_id = $_POST['company_id'];
$result = $this->purchases->getMaxVrno('sample_receive',$company_id) +1;
$this->output->set_content_type('application/json')->set_output(json_encode($result));
}

public function getMaxVrnoa_receive() {
$company_id = $_POST['company_id'];
$result = $this->purchases->getMaxVrnoa('sample_receive',$company_id) +1;
$this->output->set_content_type('application/json')->set_output(json_encode($result));
}
...
$vrnoa = $this->purchases->getMaxVrnoa('sample_issue',$stockmain['company_id']) +1;
}
$result = $this->purchases->save($stockmain,$stockdetail,$vrnoa,'sample_issue');
$response = array();
if ( $result === false ) {
$response['error'] = 'true';
}else {
...
$voucher_type_hidden = $_POST['voucher_type_hidden'];
if ($voucher_type_hidden=='new'){
$vrnoa = $this->purchases->getMaxVrnoa('sample_receive',$stockmain['company_id']) +1;
}
$result = $this->purchases->save($stockmain,$stockdetail,$vrnoa,'sample_receive');
$response = array();
if ( $result === false ) {
$response['error'] = 'true';
}else {
...
$vrnoa = $_POST['vrnoa'];
$company_id = $_POST['company_id'];
$result = $this->purchases->delete($vrnoa,'sample_issue',$company_id);
$response = "";
if ( $result === false ) {
$response = 'false';
}else {
...
$vrnoa = $_POST['vrnoa'];
$company_id = $_POST['company_id'];
$result = $this->purchases->fetchNavigation_issue($vrnoa,'sample_issue',$company_id);
$response = "";
if ( $result === false ) {
$response = 'false';
}else {
...
public function fetch_issue_detail() {
  ...
  $vrnoa = $_POST['vrnoa'];
  $company_id = $_POST['company_id'];
  $result = $this->purchases->fetch_issue_detail($vrnoa,'sample_issue',$company_id);
  $response = "";
  if ( $result === false ) {
  $response = 'false';
  }else {
...
public function fetch_receive_detail() {
  ...
  $vrnoa = $_POST['vrnoa'];
  $company_id = $_POST['company_id'];
  $result = $this->purchases->fetch_receive_detail($vrnoa,'sample_receive',$company_id);
  $response = "";
  if ( $result === false ) {
  $response = 'false';
  }else {
...
$vrnoa = $_POST['vrnoa'];
$company_id = $_POST['company_id'];
$result = $this->purchases->fetchNavigation_receive($vrnoa,'sample_receive',$company_id);
$response = "";
if ( $result === false ) {
$response = 'false';
}else {
...
$vrnoa = $_POST['vrnoa'];
$company_id = $_POST['company_id'];
$result = $this->purchases->fetch_consume($vrnoa,'sample_receive',$company_id);
$response = "";
if ( $result === false ) {
$response = 'false';
}else {
...
public function fetch_consumes() {
if (isset( $_POST )) {
$vrnoa = $_POST['vrnoa'];
$company_id = $_POST['company_id'];
$result = $this->purchases->fetch_consumes($vrnoa,'sample_receive',$company_id);
$response = "";
if ( $result === false ) {
$response = 'false';
}else {
...
$vrnoa = $_POST['vrnoa'];
$company_id = $_POST['company_id'];
$result = $this->purchases->delete($vrnoa,'sample_receive',$company_id);
$response = "";
if ( $result === false ) {
$response = 'false';
}else {
