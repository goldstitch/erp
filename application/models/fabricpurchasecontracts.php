...
class fabricPurchaseContracts extends CI_Model {
    ...
    public function fetch($vrnoa, $etype, $company_id) {
        $sql = "select m.vrnoa,m.vrno,m.wono,m.vrdate,m.approvedby,m.preparedby,m.broker_id,m.party_id,m.totweight,m.totqty,m.totamount,m.paid,m.discp,m.discount,m.comp,m.commision,m.gstp,m.gst,m.namount,m.disAddress,m.delSchedule,m.payTerms,m.uid,m.company_id,d.item_id,i.item_des,d.uom,d.pick,d.reed,d.width,d.qty,d.count,d.weight,d.rate,d.amount
