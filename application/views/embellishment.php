...
<div id="main_wrapper">
	...
	<div class="page_bar">
		<div class="row">
			<div class="col-md-12">
				<h1 class="page_title">Add Embellishment</h1>
			</div>
		</div>
	</div>
													...
													<table class="table table-striped table-hover ar-datatable">
														...
														<tbody>
															';$counter = 1;foreach ($departments as $department): ;echo '													<tr>
																	...
																	<td>&nbsp&nbsp&nbsp&nbsp';echo $department['code'];;echo '</td>
																	<td><div class="btn btn-sm btn-primary btn-edit-dept showallupdatebtn" data-transporter_id="';echo $department['name'];;echo '" data-transporter2_id="';echo $department['code'];; echo '"   data-transporter4_id="';echo $department['id'];;echo '" ><span class="fa fa-edit"></span></div></td>
																</tr>
