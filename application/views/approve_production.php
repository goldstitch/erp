...
<div id="main_wrapper">
	...
	<div class="page_bar">
		<div class="row">
			<div class="col-md-12">
				<h1 class="page_title">Approve Production </h1>
			</div>
		</div>
	</div>
	...
	<div class="page_content">
		<div class="container-fluid">
			...
			<div class="col-md-12">
                      ...
                      <div class="col-lg-2">
                      <label class="">Serial.no of Sample</label>
                      <input type="number" class="form-control input-sm " id="sr"  >
                    </div> 
                      ...
                      <input type="number" class="form-control input-sm " id="dname" >
                    </div> 
