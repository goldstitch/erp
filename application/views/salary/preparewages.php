...
<div id="main_wrapper">
	...
	<div class="page_bar">
		<div class="row">
			<div class="col-lg-3">
				<h1 class="page_title">Wages Sheet</h1>
			</div>
			<div class="col-lg-9">
				<div class="pull-right">
                	...
                	<a class="btn btn-default btnSave" data-insertbtn=\'';echo $vouchers['wages_sheet']['insert'];;echo '\'><i class="fa fa-save"></i> Save Changes</a>
                    <a href="" class="btn btn-default btnDelete" data-deletetbtn=\'';echo $vouchers['wages_sheet']['delete'];;echo '\'><i class="fa fa-trash-o"></i> Delete</a>
							...
							<div class="row">
								<div class="col-lg-2">
                                  	<div class="input-group">
                                      	...
                                      	<input type="number" class="form-control num txtidupdate" data-txtidupdate=\'';echo $vouchers['wages_sheet']['update'];;echo '\' id="txtId">
                                        ...
                                        <input type="hidden" id="wagesid" value="';echo $setting_configur[0]['wages'];;echo '">
                                        <input type="hidden" id="wagespayableid" value="';echo $setting_configur[0]['salarypayable'];;echo '">
                                	</div>
								</div>
                            	<div class="col-lg-3">
                                	<div class="input-group">
					...
					<div class="panel panel-default">
						<div class="panel-body">
								...
								<div class="col-lg-12">									
									<table class="table table-striped table-hover" id="salary_table">
										...
										<thead>
                                            ...
                                            <th class=\'text-right hide\'>Basic Salary</th>
                                            ...
                                            <th class=\'text-right hide\'>Ot Hour</th>
                                            <th class=\'text-right hide\'>OT Rate</th>
                                            <th class=\'text-right hide\'>OT Amount</th>
                                            ...
                                            <th class=\'text-right hide\'>Penalty</th>
							...
							<div class="row">
								<div class="col-lg-12">
									<div class="pull-right">
										<!-- <a class="btn btn-default btnPrintSlips" data-printtbtn=\'';echo $vouchers['wages_sheet']['print'];;echo '\'><i class="fa fa-print"></i> Print Slips</a> -->
					                    <div class="btn-group">
					                          <button type="button" class="btn btn-default btn-sm btnPrint" ><i class="fa fa-save"></i>Print F9</button>
					                          <button type="button" class="btn btn-primary btn-sm dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
					                            <span class="caret"></span>
