        ...
        <div class="col-lg-3 left_content">
            <div class="row">
                <div class="company-info company-info-block col-lg-12">
                    <span class="company-img"><img src="http://localhost:8080/naeel1/assets/img/an.png" alt="" style="width: 267px;height: 243px;"></span>
...
if($message!=''):;echo '                        <div class="row-fluid">
                            <!-- <div class="span3"></div> -->
                            <div class="col-lg-12 feedItem">
                                <div class="feed-header">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="input-prepend input-block-level">
                            <label for="">Account <img id="imgPartyLoader" class="hide" src="';echo base_url('assets/img/loader.gif');;echo '"></label>
