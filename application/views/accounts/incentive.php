...
<div id="main_wrapper">
	...
	<div class="page_bar">
		<div class="row">
			<div class="col-lg-3">
				<h1 class="page_title">Incentive Voucher</h1>
			</div>
			<div class="col-lg-9">
				<div class="pull-right">
					<a href=\'\' class="btn btn-default btnSave" data-insertbtn=\'';echo $vouchers['incentive']['insert'];;echo '\'><i class="fa fa-save"></i> Save Changes</a>
					<a href=\'\' class="btn btn-default btnDelete" data-deletetbtn=\'';echo $vouchers['incentive']['delete'];;echo '\'><i class="fa fa-trash-o"></i> Delete</a>
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<ul class="nav nav-pills">
					            <li class="active"><a href="#addupdateAdvance" data-toggle="tab">Add/Update Incentive</a></li>
					            <li><a href="#searchcash" data-toggle="tab">Search Incentive</a></li>
				          	</ul>
									...
									<div class="panel panel-default">
										<div class="panel-body">
											...
											<form action="">
												...
												<div class="row">
													<div class="col-lg-2">
														<div class="input-group">
															...
															<input type="number" id="txtId" class="form-control num txtidupdate" data-txtidupdate=\'';echo $vouchers['incentive']['update'];;echo '\'>
                                                            ...
                                                            <input type="hidden" id="incentiveid" value="';echo $setting_configur[0]['incentive'];;echo '">
														</div>
													</div>
												...
												<div class="row">
						                            <div class="col-lg-12">
						                                <table class="table table-striped report-table" id="incentive_table">
						                                    <thead>
						                                        <tr>
						                                            <th>AccId</th>
						                                            <th>Account Name</th>
								...
								<div class="tab-pane" id="searchcash">
									<div class="panel panel-default">
										<div class="panel-body">
				                            ...
				                            <div class="row">
					                            <div class="col-lg-12">
					                                <table class="table table-striped" id="search_incentive_table">
					                                    <thead>
					                                        <tr>
					                                        	<th>Vr#</th>
					                                            <th>VrDate</th>
