...
<div class="page_bar">
  <div class="row">
    <div class="col-md-4">
      <h1 class="page_title">Post Dated Cheque Issue</h1>
    </div>
    <div class="col-lg-8">
      <div class="pull-right">
        <a href=\'\' class="btn btn-default btnReset"><i class="fa fa-refresh"></i> Reset F5</a>
        <a href=\'\' class="btn btn-sm btn-default btnSave" data-saveaccountbtn=\'';echo $vouchers['account']['insert'];;echo '\' data-insertbtn=\'';echo $vouchers['chequepaidvoucher']['insert'];;echo '\' data-updatebtn=\'';echo $vouchers['chequepaidvoucher']['update'];;echo '\' data-deletebtn=\'';echo $vouchers['chequepaidvoucher']['delete'];;echo '\' data-printbtn=\'';echo $vouchers['chequepaidvoucher']['print'];;echo '\' ><i class="fa fa-save"></i> Save F10</a>
                    ...
                    <div class="panel panel-default">
                      <div class="panel-body">
                        ...
                        <form action="">
                          ...
                          <div class="row">
                            <div class="col-lg-2">
                              <div class="input-group">
                                ...
                                <input type="hidden" id="taxid" value="';echo $setting_configur[0]['tax_chq'];;echo '">
                              </div>
                            </div>
                          ...
                          <legend style=\'margin-top: 35px;\'>Issued To</legend>
                          ...
                          <div class="row">
                            ...
                            <legend style=\'margin-top: 35px;\'>Issued From</legend>
