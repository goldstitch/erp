		...
		<div class="row">
			...
			<div class="col-lg-9">
				<div class="pull-right">
					<a href=\'\' class="btn btn-default btnSave" data-insertbtn=\'';echo $vouchers['loan']['insert'];;echo '\'><i class="fa fa-save"></i> Save Changes</a>
					<a href=\'\' class="btn btn-default btnDelete" data-deletetbtn=\'';echo $vouchers['loan']['delete'];;echo '\'><i class="fa fa-trash-o"></i> Delete</a>
												...
												<div class="row">
													<div class="col-lg-2">
														<div class="input-group">
															...
															<input type="number" id="txtId" class="form-control num txtidupdate" data-txtidupdate=\'';echo $vouchers['loan']['update'];;echo '\'>
														...
														<div class="row">
							                                ...
							                                <div class="col-lg-2" style=\'width: 16%;\'>
						                                      	<div class="input-group">
						                                        	...
						                                        	<input type="text" id="txtDeduction" placeholder=\'Monthly\' class="form-control num" />
							                                    </div>
							                                </div>
