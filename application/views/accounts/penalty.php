...
<div id="main_wrapper">
	...
	<div class="page_bar">
		<div class="row">
			<div class="col-lg-3">
				<h1 class="page_title">Penalty Voucher</h1>
			</div>
			<div class="col-lg-9">
				<div class="pull-right">
					<a href=\'\' class="btn btn-default btnSave" data-insertbtn=\'';echo $vouchers['penalty']['insert'];;echo '\'><i class="fa fa-save"></i> Save Changes</a>
					<a href=\'\' class="btn btn-default btnDelete" data-deletetbtn=\'';echo $vouchers['penalty']['delete'];;echo '\'><i class="fa fa-trash-o"></i> Delete</a>
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<ul class="nav nav-pills">
					            <li class="active"><a href="#addupdatePenalty" data-toggle="tab">Add/Update Penalty</a></li>
					            <li><a href="#searchcash" data-toggle="tab">Search Penalty</a></li>
				          	</ul>

				          	<div class="tab-content">
								<div class="tab-pane active" id="addupdatePenalty">
									<div class="panel panel-default">
										<div class="panel-body">
											...
											<form action="">
												...
												<div class="row">
													<div class="col-lg-2">
														<div class="input-group">
															...
															<input type="number" id="txtId" class="form-control num txtidupdate" data-txtidupdate=\'';echo $vouchers['penalty']['update'];;echo '\' >
                                                            ...
                                                            <input type="hidden" id="penaltyid" value="';echo $setting_configur[0]['penalty'];;echo '">
														</div>
													</div>
												...
												<div class="row">
						                            <div class="col-lg-12">
						                                <table class="table table-striped report-table" id="penalty_table">
						                                    <thead>
						                                        <tr>
						                                            <th>AccId</th>
						                                            <th>Account Name</th>
								...
								<div class="tab-pane" id="searchcash">
									<div class="panel panel-default">
										<div class="panel-body">
				                            ...
				                            <div class="row">
					                            <div class="col-lg-12">
					                                <table class="table table-striped" id="search_penalty_table">
					                                    <thead>
					                                        <tr>
					                                        	<th>Vr#</th>
					                                            <th>VrDate</th>
