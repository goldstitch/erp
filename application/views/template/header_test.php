...
<html class="zoom">
    <head>
		...
		<link rel="shortcut icon" href="';echo base_url('assets/img/favicon.png');;echo '">
		<!-- bootstrap framework -->
					...
					<div class=\'col-lg-12 visible-lg\' >
						...
						<ul class=\'main-nav wall_btn\' style=\'display:inline-flex;color:white;margin-top:10px;list-style: none;\'>
							<li style="margin-top:-14px;">
								<a class="btn btn-primary btn_show" style=\'color:white !important;\'><i class="fa fa-bars"></i></a>
							</li>
							<li class="active">
