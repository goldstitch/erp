...
<div id="main_wrapper">
    ...
    <div class="page_bar">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page_title">Order Parts Detail Voucher</h1>
            </div>
        </div>
    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <ul class="nav nav-pills">
                                                    <li class="active"><a href="#itemadd" data-toggle="tab">Item Add</a></li>
                                                    <li><a href="#itemless" data-toggle="tab">Item Less</a></li>
                                                </ul>
                                            </div>
                                        </div>
