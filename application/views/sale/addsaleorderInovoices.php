  ...
  <div id="party-lookup" class="modal fade modal-lookup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div id="item-lookup" class="modal fade modal-lookup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      ...
      <div class="page_bar">
        <div class="row">
          <div class="col-md-2">
            <h1 class="page_title">Sale Return</h1>
          </div>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-lg-2">                                                
                                      ...
                                      <select class="form-control input-sm" id="InvType_dropdown">
                                        <option value="export" selected="">Exchange</option>
                                      </select>                                            
                                    </div>    
                                        ...
                                        <div class="tab-pane active fade in" id="itemadd">
                                          <div class="container-wrap">
                                            ...
                                            <div class="row">
                                              ...
                                              <div class="col-lg-1">
                                                <label for="">Gst</label>                                                    
                                                <input type="text" class="form-control num" id="txtGstAmount" value="0">                                                    
                                              </div>
                                              <div class="col-lg-2">
                                              ...
                                              <input type="text" class="form-control num" id="disc" disabled="disabled">                                                    
                                            </div>
                                            <div class="col-lg-2">
                                            <label for="">Discount</label>                                                    
                                            <input type="text" class="form-control num" id="disctotal" disabled="disabled"> 
