...
<div class="page_bar">
  <div class="row">
    <div class="col-md-12">
      <h1 class="page_title">Sale Voucher</h1>
    </div>
  </div>
</div>
                        ...
                        <div class="col-lg-2" >
                          ...
                          <div class="input-group">
                            ...
                            <select class="form-control select2" id="itemid_dropdown">
                              ...
                              ';foreach ($items as $item): ;echo '                                <option value="';echo $item['item_id'];;echo '" data-uom_item="';echo $item['uom'];;echo '" data-srate="';echo $item['srate'];;echo '" data-prate="';echo $item['cost_price'];;echo '" data-grweight="';echo $item['grweight'];;echo '">';echo $item['item_id'];;echo '</option>
                              ';endforeach ;echo '                            </select>
                          </div>
                        </div>
                        <div class="col-lg-3" >
                                              ...
                                              <div class="panel-body">
                                                ...
                                                <div class="row">                                                                                    
                                                  <div class="col-lg-8">
                                                    ...
                                                    <div class="btn-group">
                                                      <button type="button" class="btn btn-default btn-sm btnPrint btnPrintNew"  ><i class="fa fa-print"></i>Print F91</button>
