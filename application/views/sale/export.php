                        ...
                        <div class="page_bar">
                            <div class="row">
                                ...
                                <div class="col-lg-9 text-right">
                                    ...
                                    data-insertbtn=\'';echo $vouchers['exportvoucher']['insert'];;echo '\'
                                    data-updatebtn=\'';echo $vouchers['exportvoucher']['update'];;echo '\'
                                    data-deletebtn=\'';echo $vouchers['exportvoucher']['delete'];;echo '\'
                                    data-printbtn=\'';echo $vouchers['exportvoucher']['print'];;echo '\'><i class="fa fa-save"></i> Save F10</a>
                                        ...
                                        <div class="tab-pane active fade in" id="Main">
                                            <div class="row">
                                                            ...
                                                            <form action="">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-2">
                                                                        ...
                                                                        <input class=\'form-control input-sm \' type=\'text\' id=\'txtSaleInv\'>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-2">
                                                        <label>Hs Code</label>
                                                        <input class="form-control input-sm"  placeholder="" id="txtHsCode">
                                                    </div>
                                                                                    ...
                                                                                    <div class="col-lg-12">
                                                                                        <div id="no-more-tables">
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <th class="numeric text-right hide">
                                                                                                    No of carton
                                                                                                </th>
                                                                                                <th class="numeric text-right">
                                                                                                    Color
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 text-right">
                                                    <a class="btn btn-sm btn-default btnReset"><i
                                                        ...
                                                        data-updatebtn=\'';echo $vouchers['exportvoucher']['update'];;echo '\'
                                                        data-deletebtn=\'';echo $vouchers['exportvoucher']['delete'];;echo '\'
                                                        data-printbtn=\'';echo $vouchers['exportvoucher']['print'];;echo '\'><i
