                                        ...
                                        <div class="tab-pane active fade in" id="itemadd">
                                          <div class="container-wrap">
                                            ...
                                            <div class="row">
                                              ...
                                              <input type="text" class="form-control num" id="disc" >                                                    
                                            </div>
                                            <div class="col-lg-2">
                                            <label for="">Discount</label>                                                    
                                            <input type="text" class="form-control num" id="disctotal"> 
                                                                                            
                                          </div>

                                              <div class="col-lg-1">  
                                              <label for="">Add Disc</label>                                          
                                              <button type="button" class="btn btn-default btn-sm btndisc" ><i class="fa fa-save"></i></button>
                                              </div>  
                                              <div class="col-lg-1">   
                                              <label for="">Add</label>                                                  
