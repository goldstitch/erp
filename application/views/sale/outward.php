...
<div id="main_wrapper">
    ...
    <div class="modal-dialog modal-md">
        ...
        <div class="page_bar">
            <div class="row">
                <div class="col-md-4">
                    <h1 class="page_title">Outward Gate Pass</h1>
                </div>
                <div class="col-lg-8">
                    <a class="btn btn-sm btn-default btnReset"><i class="fa fa-refresh"></i> Reset F5</a>
                    <a class="btn btn-sm btn-default btnSave" data-savegodownbtn=\'';echo $vouchers['warehouse']['insert'];;echo '\' data-saveaccountbtn=\'';echo $vouchers['account']['insert'];;echo '\' data-savetransporterbtn=\'';echo $vouchers['transporter']['insert'];;echo '\' data-saveitembtn=\'';echo $vouchers['item']['insert'];;echo '\' data-insertbtn=\'';echo $vouchers['outwardvoucher']['insert'];;echo '\' data-updatebtn=\'';echo $vouchers['outwardvoucher']['update'];;echo '\' data-deletebtn=\'';echo $vouchers['outwardvoucher']['delete'];;echo '\' data-printbtn=\'';echo $vouchers['outwardvoucher']['print'];;echo '\' ><i class="fa fa-save"></i> Save F10</a>
                                                                    ...
                                                                    <div class="row" style="margin-top:0px;">
                                                                        ...
                                                                        <div class="col-lg-2">                                                
                                                                            ...
                                                                            <select class="form-control" id="rgp_dropdown">
                                                                                <!-- <option value="non returnable" disabled="" selected="">non returnable</option> -->
                                                                                                        ...
                                                                                                        <table class="col-lg-12 table-bordered table-striped table-condensed cf" id="purchase_table">
                                                                                                            ...
                                                                                                            <tfoot class="tfoot_tbl">
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td data-title="" class="numeric" id="txtTotalDozen"></td>
                                                                                                                    <td data-title="" class="numeric" id="txtTotalBag"></td>
                                                                                                                    <td data-title="" class="numeric" id="txtTotalQty"></td>
                                                                                                                    <td data-title="" class="numeric" id="txtTotalWeight"></td>                                   
                                                                                                                    <td data-title="" class="numeric" class="numeric hidden"></td>
                                                                                                                    <!-- <td data-title="" class="numeric" class="numeric hidden" id="txtTotalAmount"></td> -->
                                                                                                                    <!-- <td data-title="" class="numeric" class="numeric hidden"></td> -->
                                                                                                                    <!-- <td data-title="" class="numeric"></td> -->
                                                                                                                </tr>
                                                                                                            </tfoot>
