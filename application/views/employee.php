								...
								<div class="col-lg-12">
									<div class="panel panel-default">
                                        ...
                                        <div class="row">
											<div class="col-lg-5">
											<div class="input-group">
											<span class="input-group-addon id-addon">Type</span>
											<select class="form-control select2" id="type">
											<option value="" disabled="" selected="">Select Type</option>
											<option value="Adda_work/stone_work">Adda_work/stone_work</option>
											<option value="Cutting_&_Stitching">Cutting_&_Stitching</option>
											<option value="Digital_printing">Digital_printing</option>
											<option value="Dying">Dying</option>
											<option value="Embroidory">Embroidory</option>
											<option value="Embellishment">Embellishment</option>
											<option value="Stonework">Stone_work</option>
											</select>
											</div>
									        </div>
										</div> 
                                        ...
                                        <div class="row">
											<div class="col-lg-5">
											<div class="input-group">
											<span class="input-group-addon id-addon">Location</span>
                                          <select class="form-control select2" id="dept">
                                          <option value="" disabled="" selected="">Location</option>
                                          ';foreach ($departmentss as $department): ;echo '                                            <option value="';echo $department['did'];;echo '">';echo $department['name'];;echo '</option>
													...
													<table class="table table-striped table-hover ar-datatable">
														...
														<tbody>
															';$counter = 1;foreach ($departments as $department): ;echo '													<tr>
																	...
																	<td>&nbsp&nbsp&nbsp';echo $department['location'];;echo '</td>
																	<td><div class="btn btn-sm btn-primary btn-edit-dept showallupdatebtn" data-transporter_id="';echo $department['name'];;echo '" data-transporter2_id="';echo $department['type'];; echo '"  data-transporter4_id="';echo $department['id'];;echo '"  data-transporter5_id="';echo $department['location'];;echo '" ><span class="fa fa-edit"></span></div></td>
