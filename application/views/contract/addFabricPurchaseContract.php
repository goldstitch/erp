...
<div id="AccountAddModel" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="AccountAddModelLabel"
    ...
    <div class="page_bar">
        <div class="row">
            <div class="col-md-4">
                <h1 class="page_title">Fabric Purchase Contract</h1>
            </div>
            <div class="col-lg-8">
                <a class="btn btn-sm btn-default btnReset"><i class="fa fa-refresh"></i> Reset F5</a>
                <a class="btn btn-sm btn-default btnSave" data-saveaccountbtn=\'';echo $vouchers['account']['insert'];;echo '\' data-saveitembtn=\'';echo $vouchers['item']['insert'];;echo '\' data-insertbtn=\'';echo $vouchers['fabricpurchasevoucher']['insert'];;echo '\' data-updatebtn=\'';echo $vouchers['fabricpurchasevoucher']['update'];;echo '\' data-deletebtn=\'';echo $vouchers['fabricpurchasevoucher']['delete'];;echo '\' data-printbtn=\'';echo $vouchers['fabricpurchasevoucher']['print'];;echo '\' ><i class="fa fa-save"></i> Save F10</a>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <form action="">
                                                ...
                                                <div class="container-wrap">
                                                    <div class="row">
                                                       ...
                                                       <!--  <div class="col-lg-2">
                                                         ...
                                                         <!-- <div class="col-lg-1">
                                                            ...
                                                            <input type="text" class="form-control" id="txtCount" >                                                    
                                                        </div>-->
                                                        
                                                        <div class="col-lg-1 hide">
                                                            <label for="">Qty</label>                                                    
                                                            <input type="text" class="form-control num" id="txtQtyGross" >                                                    
                                                        </div>
                                                        <div class="col-lg-1 hide">
                                                            <label for="">LKami</label>                                                    
                                                            <input type="text" class="form-control num" id="txtLKami" >                                                    
                                                        </div>
                                                        <div class="col-lg-1 hide">
                                                            <label for="">Shortage</label>                                                    
                                                            <input type="text" class="form-control num" id="txtShortage" >                                                    
                                                        </div> 
                                                    ...
                                                    <div class="col-lg-1">
                                                        <label>Pick</label>
                                                        <input type="text" list=\'pick\' class="form-control input-sm" id="txtPick" />
                                                        <datalist id=\'pick\'>
                                                    ...
                                                    <div class="col-lg-1 hide">
                                                        <label>Reed1</label>
                                                        <input type="text" list=\'reed\' class="form-control input-sm" id="txtReed" />
                                                        <datalist id=\'reed\'>
                                                    ...
                                                    <div class="col-lg-1">
                                                        <label>Width</label>
                                                        <input type="text" list=\'width\' class="form-control input-sm" id="txtWidth" />
                                                        <datalist id=\'width\'>
                                                        ...
                                                        <table class="col-lg-12 table-bordered table-striped table-condensed cf " id="sale_table">
                                                            <thead class="cf">
                                                                <tr>
                                                                    ...
                                                                    <th>Item Detail</th>
                                                                    <th>UOM</th>
                                                                    <th class="hide numeric text-right">Count</th>
                                                                    
                                                                    <th class="numeric text-right hide">Qty</th>
                                                                    <th class="numeric text-right hide">LKami</th>
                                                                    <th class="numeric text-right hide">Shortage</th>
                                                            ...
                                                            <tfoot class="tfoot_tbl">
                                                                <tr>
                                                                    <td data-title="" class="text-right" colspan="3">Totals</td>
                                                                    <td data-title="Qty" class="hide text-right numeric txtTotalQtyG"></td>
                                                                    <td data-title="LKami" class="hide text-right numeric txtTotalLKami"></td>
                                                                    <td data-title="Shortage" class="hide text-right numeric txtTotalShortage"></td>

                                                                    <td data-title="NetQty" class="text-right numeric txtTotalQty"></td>
