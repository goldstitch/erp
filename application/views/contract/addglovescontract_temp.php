...
<div id="main_wrapper">
    ...
    <div class="page_bar">
	   <div class="row">
		  <div class="col-md-12">
			 <h1 class="page_title">Gloves Calculation </h1>
		  </div>
	   </div>
    </div>
								...
								<div class="panel-body">
								    ...
								    <form action="">
									   ...
									   <div class="row">
										  ...
										  <div class="col-lg-2">
											 <!-- <div class="input-group"> -->
												<span class="">Issue For PO#</span>
												<input class="form-control input-sm"  id="ponum" >
											 <!-- </div> -->
										  </div>
									   </div>
									   ...
									   <div class="container-wrap">
										  ...
										  <div class="col-lg-1" style="width:100px;" >
										   ...
										   <div class="col-lg-4" style="width:300px;">
											 ...
											 <div class="col-lg-1" style="width:85px; padding:0px" >
												<label for="">Item Qty(Dzn)</label>
												<input type="text" list=\'color\' class="form-control num" id="txtQty"  />
												   
											 </div>
											 <div class="col-lg-1" style="width:125px;" >
												<label for="">Item Weight (G)</label>
												<input type="text" list=\'color\' class="form-control num" id="txtWeight"  />
												    
											 </div>
											 <div class="col-lg-1" >
												<label for="">Wastge%</label>
												<input type="text" list=\'color\' class="form-control num" id="txtWastge"  />
												<datalist id=\'color\'>
												';foreach ($colors as $col): ;echo '												    <option value="';echo $col['colors'];;echo '">
												';endforeach ;echo '												</datalist>    
											 </div>
											 <div class="col-lg-2">
												<label for="">Yarn Bag Rt</label>                                                    
												<!-- <input type="text" class="form-control num" id="txtBrand">   
												<label>Approved By</label> -->
												<input type="text" list=\'brand\' class="form-control num" id="txtBagRt"  />
												                                              
											 </div>
											  <!-- <div class="col-lg-1">
												<label for="">Count</label>                                                    
												<input type="text" class="form-control readonly num" id="txtCount" >                                                    
											 </div> -->
											 <div class="col-lg-1" style="width:105px;">
												<label>Yarn Bag Wt</label>
												<input type="text" list=\'count\' class="form-control input-sm" id="txtBagwt" />
												<datalist id=\'count\'>
												    ';foreach ($counts as $count): ;echo '													   <option value="';echo $count['count'];;echo '">
												    ';endforeach ;echo '												</datalist>
											 </div>
											 <div class="col-lg-1" style="width:115px;">
												<label>Knitting Chrgs</label>
												<input type="text"  class="form-control num" id="txtKnitt" />
										  ...
										  <div class="row">
											 ...
											 <div class="col-lg-1 hide">
											  ...
											  <div class="col-lg-1">
												<label>CMT Chrgs</label>
												<input type="text" class="form-control num" id="txtCmt" />
												
											 </div>
											 <div class="col-lg-1"style="width:160px;">
												<label>Dying/Washing Chrgs</label>
												<input type="text"  class="form-control num" id="txtDying" />
												
											 </div>                                 
											 <div class="col-lg-1">
												<label for="">Dot Chrgs</label>                                                    
												<input type="text" class="form-control num" id="txtDot">                                                    
											 </div>
											 <div class="col-lg-1">
												<label for="">Item Rate</label>                                                    
												<input type="text" class="form-control num" id="txtItrate">                                                    
											 </div>
											 <div class="col-lg-2">
												<label for="">Item Value</label>                                                    
												<input type="text" class="form-control num" id="txtItvalue">                                                    
											 </div>
											 <div class="col-lg-1"style="width:140px;">
												<label for="">Item Required Wt.</label>                                                    
												<input type="text" class="form-control num" id="txtItReq">                                                    
											 </div>
											 <div class="col-lg-1"style="width:150px;">
												<label for="">Required Yarn Bags</label>                                                    
												<input type="text" class="form-control num" id="txtReqyarn">                                                    
											 </div>
											 <div class="col-lg-1">
												<label for="">Yarn Sent</label>                                                    
												<input type="text" list=\'yarnsent\' class="form-control " id="txtsent"  />
												<datalist id=\'yarnsent\'>
												';foreach ($sender as $send): ;echo '												    <option value="';echo $send['sents'];;echo '">
												';endforeach ;echo '												</datalist>                                                   
											 </div>
									   ...
									   <div class="row">
										  <div class="col-lg-12">
											 ...
											 <table class="col-lg-12 table-bordered table-striped table-condensed cf " id="purchase_table">
												<thead class="cf">
												    <tr>
													   <th class="numeric" >Item Id</th>
													   <th class="numeric" >Item Name</th>
													   <th>Item Qty(Dzn)</th>
													   <th>Item Weight<br>(G)</th>
													   <th>Wastge%</th>
													   <th>Yarn Bag Rt</th>
													   <th class="numeric">Yarn Bag Wt</th>
													   <th class="">Knitting Chrgs</th>
													   <th class="numeric">CMT<br> Chrgs</th>
													   <th class="numeric">Dying/<br>Washing Chrgs</th>
													   <th class="numeric">Dot<br> Chrgs</th>
													   <th class="numeric text-right">Item Rate</th>
													   <th>Item Value</th>
													   <th>Item<br> Required Wt.</th>
													   <th>Required <br>yarn Bags</th>
													   <th>Yarn Sent</th>
													   <th>Action</th>
												    </tr>
												</thead>
												...
												<tfoot class="tfoot_tbl">
												    <tr>
												    <td data-title="" class="text-right numeric txtTotalQty"></td>
												    <td data-title="" class="text-right" colspan="0">Totals</td>

												    <td data-title="" class="text-right numeric txtTotalQty" id="classdzn"></td>
												    <td data-title="" class="text-right numeric txtTotalQty" id="classWeight"></td>
												    
												    <td data-title="" class="text-right numeric txtTotalQty"></td>
												    <td data-title="" class="text-right numeric txtTotalQty"></td>
												    <td data-title="" class="text-right numeric txtTotalWeight"></td>
												    <td data-title="" class="text-right numeric txtTotalRate"></td>
												    <td data-title="" class="text-right numeric txtTotalAmount"></td>
												    <td data-title="" class="text-right numeric txtTotalAmount"></td>
												    <td data-title="" class="text-right numeric txtTotalAmount"></td>
												    <td data-title="" class="text-right numeric txtTotalAmount"></td>
												    <td data-title="" class="text-right numeric txtTotalAmount" id="classitemval"></td>
												    <td data-title="" class="text-right numeric txtTotalAmount" id="classitemWt"></td>
												    <td data-title="" class="text-right numeric txtTotalAmount" id="classrequiredyarn"></td>
												    <td data-title="" class="text-right numeric txtTotalAmount"></td>
								...
								<div class="panel-body">
								    ...
								    <div class="row">                                                                                    
									   <div class="col-lg-12">
										  ...
										  <a class="btn btn-sm btn-default btnSave" data-savegodownbtn=\'';echo $vouchers['warehouse']['insert'];;echo '\' data-saveaccountbtn=\'';echo $vouchers['account']['insert'];;echo '\' data-saveitembtn=\'';echo $vouchers['item']['insert'];;echo '\' data-insertbtn=\'';echo $vouchers['glovecalculation']['insert'];;echo '\' data-updatebtn=\'';echo $vouchers['glovecalculation']['update'];;echo '\' data-deletebtn=\'';echo $vouchers['glovecalculation']['delete'];;echo '\' data-printbtn=\'';echo $vouchers['glovecalculation']['print'];;echo '\' ><i class="fa fa-save"></i> Save F10</a>
										  <a class="btn btn-sm btn-default btnDelete"><i class="fa fa-trash-o"></i> Delete F12</a>
										  
										 <div class="btn-group">
										    <button class="btn btn-default btn-sm btnPrint" type="button"><i class="fa fa-save"></i>Print F9</button>
										    ...
										    <ul role="menu" class="dropdown-menu">
											 <li><a class="btnprintHeader" href="#"> Print with header</a></li><a class="btnprintHeader" href="#">
											 </a><li><a class="btnprintwithOutHeader" href="#"> Print with Out header</a></li></ul></div>
										  ...
										  <a href="#item-lookup" data-toggle="modal" class="btn btn-sm btn-info btnsearchitem " style="margin-left:3px;"><i class="fa fa-search"></i>&nbsp;Item Lookup</a>
									   </div>
