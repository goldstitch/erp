...
<div id="AccountAddModel" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="AccountAddModelLabel"
    ...
    <div class="page_bar">
        <div class="row">
            <div class="col-md-4">
                <h1 class="page_title">Yarn Purchase Contract</h1>
            </div>
            <div class="col-lg-8">
                <a class="btn btn-sm btn-default btnReset"><i class="fa fa-refresh"></i> Reset F5</a>
                <a class="btn btn-sm btn-default btnSave" data-saveaccountbtn=\'';echo $vouchers['account']['insert'];;echo '\' data-saveitembtn=\'';echo $vouchers['item']['insert'];;echo '\' data-insertbtn=\'';echo $vouchers['yarnpurchasevoucher']['insert'];;echo '\' data-updatebtn=\'';echo $vouchers['yarnpurchasevoucher']['update'];;echo '\' data-deletebtn=\'';echo $vouchers['yarnpurchasevoucher']['delete'];;echo '\' data-printbtn=\'';echo $vouchers['yarnpurchasevoucher']['print'];;echo '\' ><i class="fa fa-save"></i> Save F10</a>
                ...
                <a href="#party-lookup" data-toggle="modal" class="btn btn-sm btn-info btnupdate"><i class="fa fa-search"></i>&nbsp;Account Lookup F1</a>
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <table class="col-lg-12 table-bordered table-striped table-condensed cf " id="sale_table">
                                                            ...
                                                            <tfoot class="tfoot_tbl">
                                                                <tr>
                                                                    <td data-title="" class="text-right" colspan="6">Totals</td>
