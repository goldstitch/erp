...
<div id="main_wrapper">
  ...
  <div class="page_bar">
    <div class="row">
      <div class="col-md-4">
        <h1 class="page_title">Material Issuance</h1>
      </div>
      <div class="col-lg-8">
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                          ...
                          <div class="panel-body">
                            ...
                            <form action="">
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-3">
                                <div class="input-group">
                                  <span class="input-group-addon txt-addon ">Design Id</span>
                                ...
                                <div class="container-wrap">
                                  <div class="row">
                                    <div class="col-lg-3">
                                      ...
                                      <div class="col-lg-1">
                                        <label>Receive</label>
                                        <input type="text" class="form-control num" id="txtRec">
                                      </div>
                                      <div class="col-lg-1">
                                        <label>Qty</label>
                                        <input type="number" class="form-control num" id="txtSQty">
                                      </div>

                                      <div class="col-lg-1">
                                        <label>Balance</label>
                                        <input type="number" class="form-control num" id="balance" readonly="">
                                      </div>
                                      <div class="col-lg-2">
                                        ...
                                        <table class="table table-striped table-bordered" id="purchase_table">
                                          <thead class="cf tbl_thead">
                                            <tr>
                                              ...
                                              <th data-title=\'Received\' style=\'text-align:right;\'>Received</th>
                                              <th data-title=\'Weight\' style=\'text-align:right;\'>Qty</th>
                                              <th data-title=\'Weight\' style=\'text-align:right;\'>Balance</th>
                        ...
                        <div class="row">
                          ...
                          <table class="table table-striped Lmaterial_table font_tbl">
                            <thead>
                              <tr>
                                <th>Material</th>
                                <th >QTY</th>
