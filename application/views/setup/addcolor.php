...
<div id="main_wrapper">
	...
	<div class="page_bar">
		<div class="row">
			<div class="col-md-12">
				<h1 class="page_title">Add Color</h1>
			</div>
		</div>
	</div>
		...
		<div class="container-fluid">
			...
			<div class="col-md-12">
				<ul class="nav nav-tabs" id="tabs_a">
					<li class="active"><a data-toggle="tab" href="#add_dept">Add Color </a></li>
											...
											<div class="row">
												<div class="col-lg-2">
													<div class="input-group">
														<div class="input-group-addon id-addon">Color. Id</div>
								...
								<div class="panel panel-default">
									<div class="panel-body">
										<table class="table table-striped table-hover ar-datatable">
											...
											<tbody>
												';$counter = 1;foreach ($colors as $color): ;echo '													<tr>
														<td>';echo $counter++;;echo '</td>
														<td>';echo $color['name'];;echo '</td>
														<td>';echo $color['description'];;echo '</td>
														<td><a href="" class="btn btn-sm btn-primary btn-edit-dept" data-id="';echo $color['color_id'];;echo '"><span class="fa fa-edit"></span></a></td>
													</tr>
