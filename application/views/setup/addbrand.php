...
<div id="main_wrapper">
	...
	<div class="page_bar">
		<div class="row">
			<div class="col-md-12">
				<h1 class="page_title">Add Brand</h1>
			</div>
		</div>
	</div>
		...
		<div class="container-fluid">
			...
			<div class="col-md-12">
				<ul class="nav nav-tabs" id="tabs_a">
					<li class="active"><a data-toggle="tab" href="#add_brand">Add/Update Brand</a></li>
					<li class=""><a data-toggle="tab" href="#view_all">View All</a></li>
				</ul>
				<div class="tab-content">
					<div id="add_brand" class="tab-pane fade active in">
											...
											<div class="row">
												<div class="col-lg-12">
													<div class="pull-right">
														...
														<a class="btn btn-sm btn-default btnSave" data-saveaccountbtn=\'';echo $vouchers['account']['insert'];;echo '\' data-saveitembtn=\'';echo $vouchers['item']['insert'];;echo '\' data-insertbtn=\'';echo $vouchers['brand']['insert'];;echo '\' data-updatebtn=\'';echo $vouchers['brand']['update'];;echo '\' data-deletebtn=\'';echo $vouchers['brand']['delete'];;echo '\' data-printbtn=\'';echo $vouchers['brand']['print'];;echo '\' ><i class="fa fa-save"></i> Save F10</a>
								...
								<div class="panel panel-default">
									<div class="panel-body">
										<table class="table table-striped table-hover ar-datatable">
											...
											<tbody>
												';if (isset($brands)): ;echo '													';$counter = 1;foreach ($brands as $brand): ;echo '														<tr>
															<td>';echo $counter++;;echo '</td>
															<td>';echo $brand['name'];;echo '</td>
															<td>';echo $brand['description'];;echo '</td>
															<td><a href="" class="btn btn-sm btn-primary btn-edit-brand" data-bid="';echo $brand['bid'];;echo '"><span class="fa fa-edit"></span></a></td>
														</tr>
