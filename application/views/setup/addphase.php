...
<div id="main_wrapper">
	...
	<div class="page_bar">
		<div class="row">
			<div class="col-md-12">
				<h1 class="page_title">Add Phase</h1>
			</div>
		</div>
	</div>
		...
		<div class="container-fluid">
			...
			<div class="col-md-12">
				<ul class="nav nav-tabs" id="tabs_a">
					<li class="active"><a data-toggle="tab" href="#add_category">Add/Update Phase</a></li>
										...
										<!-- 	<div class="row">
												<div class="col-lg-4">
													<div class="input-group">
														...
														<select class="form-control input-sm input-sm select2" id="phaseType_dropdown">
															<option value="" disabled="" selected="">Choose Phase Type</option>
															';foreach ($types as $type): ;echo '																<option value="';echo $type['id'];;echo '">';echo $type['name'];;echo '</option>
										...
										<table class="table table-striped table-hover ar-datatable">
											<thead>
												<tr>
													...
													<!-- <th style=\'background: #368EE0;\'>Phase Type</th> -->
													<th style=\'background: #368EE0;\'>Phase Name</th>
													<th style=\'background: #368EE0;\'>Description</th>
													<th style=\'background: #368EE0;\'></th>
												</tr>
											</thead>
											<tbody>
												';if (isset($phases)): ;echo '													';$counter = 1;foreach ($phases as $phase): ;echo '														<tr>
															<td>';echo $counter++;;echo '</td>
															<!-- <td>';echo $phase['phasetype_name'];;echo '</td> -->
															<td>';echo $phase['name'];;echo '</td>
															<td>';echo $phase['description'];;echo '</td>
															<td><a href="" class="btn btn-sm btn-primary btn-edit-cat" data-id="';echo $phase['id'];;echo '"><span class="fa fa-edit"></span></a></td>
														</tr>
