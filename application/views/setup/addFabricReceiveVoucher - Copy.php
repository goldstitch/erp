										...
										<div class="panel-body">
											...
											<fieldset style="">
												...
												<div class="row">
													...
													<div class="col-lg-4">
														...
														<div class="input-group">
															<div class="input-group-addon txt-addon VoucherNoLable">A Grade</div>
												...
												<div class="row">
													<div class="col-lg-8">
														<div class="input-group">
															...
															<input type="text" class="form-control" id="txtBGradeItemId" >
															<img id="imgYarnwLoader" class="hide" src="';echo base_url('assets/img/loader.gif');;echo '">
															<input id="hfBGradeItemId" type="hidden" value="" />
															<input id="hfBGradeItemwBalance" type="hidden" value="" />
															<input id="hfBGradeItemCity" type="hidden" value="" />
															<input id="hfBGradeItemwAddress" type="hidden" value="" />
															<input id="hfBGradeItemwCityArea" type="hidden" value="" />
															<input id="hfBGradeItemwMobile" type="hidden" value="" />
															<input id="hfBGradeItemwUname" type="hidden" value="" />
															<input id="hfBGradeItemwLimit" type="hidden" value="" />
															<input id="hfBGradeItemwName" type="hidden" value="" />
															<input id="hfBGradeItemwGrWeight" type="hidden" value="" />


															<input id="hfBGradeItemWeftInventoryId" type="hidden" value="" />
													...
													<div class="col-lg-4">
														...
														<div class="input-group">
															<div class="input-group-addon txt-addon VoucherNoLable">B Grade</div>
												...
												<div class="row">
													...
													<div class="col-lg-4">
														...
														<div class="input-group">
															<div class="input-group-addon txt-addon VoucherNoLable">C Grade</div>
											...
											<fieldset>
												...
												<div class="row">
													...
													<div class="col-lg-4 ">
														<div class="input-group">
															...
															<input type="text" class="form-control input-sm num" disabled id="txtAmount">
														</div>
													</div>
													<div class="col-lg-4">
														<div class="input-group">
															<div class="input-group-addon txt-addon VoucherNoLable">Inc Tax</div>

															<input type="text" class="form-control input-sm num"  id="txtIncomeTax" style="width: 40px !important;" placeholder="%">
															<input type="text" class="form-control input-sm num"  id="txtIncomeTaxValue">
														</div>
													</div>
												...
												<div class="row">
													...
													<div class="col-lg-4">
														<div class="input-group">
															<span class="input-group-addon txt-addon VoucherNoLable" style="margin-left: 20px !important">User: </span>
													...
													<div class="col-lg-4">
														<div class="input-group">
															<span class="input-group-addon txt-addon VoucherNoLable">Posting: </span>
