...
<div id="main_wrapper">
	...
	<div class="page_bar">
		<div class="row">
			<div class="col-md-6">
				<h1 class="page_title">Yarn Return Voucher</h1>
			</div>
			<div class="col-lg-6 pull-right">
				
				<a class="btn btn-sm btn-default btnSave" data-savegodownbtn=\'';echo $vouchers['warehouse']['insert'];;echo '\' data-saveaccountbtn=\'';echo $vouchers['account']['insert'];;echo '\' data-saveitembtn=\'';echo $vouchers['item']['insert'];;echo '\' data-insertbtn=\'';echo $vouchers['yarnreturnvoucher']['insert'];;echo '\' data-updatebtn=\'';echo $vouchers['yarnreturnvoucher']['update'];;echo '\' data-deletebtn=\'';echo $vouchers['yarnreturnvoucher']['delete'];;echo '\' data-printbtn=\'';echo $vouchers['yarnreturnvoucher']['print'];;echo '\' ><i class="fa fa-save"></i> Save F10</a>
