											...
											<div class="row">
												<div class="col-lg-2">
													<div class="input-group">
														...
														<input type="hidden" id="overtimeid" value="';echo $setting_configur[0]['overtime'];;echo '">
										...
										<table class="table table-striped table-hover ar-datatable">
											...
											<tbody>
												';$counter = 1;foreach ($overtimes as $overtime): ;echo '													<tr>
														...
														<!-- <td><a href="" class="btn btn-primary btn-edit-overtime showallupdatebtn" data-showallupdatebtn=';
;echo ' data-dcno="';echo $overtime['dcno'];;echo '"><span class="fa fa-edit"></span></a></td> -->
