...
<script id="general-vhead-template-is" type="text/x-handlebars-template">
  <tr class="hightlight_tr">
   <td></td>
   <td></td>
...
<script id="general-vhead-template-is-stit" type="text/x-handlebars-template">
  <tr class="hightlight_tr">
   <td></td>
   <td></td>
...
<script id="general-vhead-template-is-stit-value" type="text/x-handlebars-template">
  <tr class="hightlight_tr">
   <td></td>
   <td></td>
...
<script id="general-vhead-template-value-stit" type="text/x-handlebars-template">
  <tr class="hightlight_tr">
   <td></td>
   <td></td>
   <td></td>
...
<script id="general-vhead-template-is-value" type="text/x-handlebars-template">
  <tr class="hightlight_tr">
   <td></td>
   <td></td>
...
<script id="general-head-template-is-stit" type="text/x-handlebars-template">
  <tr>
    <th class="no_sort" style="width: 50px;">Sr#</th>
    <th class="no_sort" style="width: 50px;">ItemId</th>
    <th class="no_sort" style="width: 900px;">Description </th>
    <th class="no_sort" style="width: 50px;">Uom</th>
    <th class="no_sort" style="text-align:right; width: 150px;">Opening </th>
    <th class="no_sort" style="text-align:right; width: 150px;">Out </th>
    <th class="no_sort" style="text-align:right; width: 150px;">In </th>
    <th class="no_sort" style="text-align:right; width: 150px;">Balance</th>

    <th class="no_sort" style="text-align:right; width: 150px;">Op Outside </th>
    <th class="no_sort" style="text-align:right; width: 150px;">Issue   </th>
    <th class="no_sort" style="text-align:right; width: 150px;">Receive  </th>
    <th class="no_sort" style="text-align:right; width: 150px;">Bal Outside </th>
    <th class="no_sort" style="text-align:right; width: 150px;">Total </th>


  </tr>
</script>

<script id="general-head-template-is-stit-value" type="text/x-handlebars-template">
  <tr>
    <th class="no_sort" style="width: 50px;">Sr#</th>
    <th class="no_sort" style="width: 50px;">ItemId</th>
    <th class="no_sort" style="width: 900px;">Description </th>
...
<script id="general-grouptotal-template-is-head" type="text/x-handlebars-template">
  <tr class="finalsum">
   <td></td>
   <td></td>
   <td></td>
...
<script id="general-grouptotal-template-is-head-value" type="text/x-handlebars-template">
  <tr class="finalsum">
   <td></td>
   <td></td>
   <td></td>
...
<script id="general-grouptotal-template-is-stit" type="text/x-handlebars-template">
  <tr class="finalsum">
   <td></td>
   <td></td>
   <td></td>
   ...
   <td style="text-align:right !important;">{{INWEIGHT}}</td>
   <td style="text-align:right !important;">{{BALANCEWEIGHT}}</td>
   <td style="text-align:right !important;">{{GRANDBALANCE}}</td>
...
<script id="general-grouptotal-template-is-stit-value" type="text/x-handlebars-template">
  <tr class="finalsum">
   <td></td>
   <td></td>
   <td></td>
...
<script id="general-item-template-is-stit" type="text/x-handlebars-template">
  <tr>
   <td>{{SERIAL}}</td>
   <td>{{ITEM_ID}}</td>
   <td>{{DESCRIPTION}}</td>
...
<script id="general-item-template-is-stit-value" type="text/x-handlebars-template">
  <tr>
   <td>{{SERIAL}}</td>
   <td>{{ITEM_ID}}</td>
   <td>{{DESCRIPTION}}</td>
...
<div id="main_wrapper">
  ...
  <div class="page_bar">
    <div class="row">
      <div class="col-md-12">
        <h1 class="page_title">Stock Report</h1>
      </div>
    </div>
  </div>
                    ...
                    <div class="col-lg-6">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-2">
                          <div class="form-group">
                            <label class="radio-inline">
                              <input type="radio" name="rbRptstock" id="Radio5" value="all" checked="checked">
                              All
                            </label>
                            <label class="radio-inline">
                              <input type="radio" name="rbRptstock" id="Radio6" value="returnable">
                              Only Returnable
                            </label>
                          </div>
                        </div>
