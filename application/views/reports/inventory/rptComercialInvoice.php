		...
		<div class="container-fluid">
			<div class="row-fluid" >
				<div class="span12 centered">
					...
					';if ($title != ''):  ;echo '						<div class="row-fluid">
								...
								<table class="header_tbl">
									...
									<tbody>
										<tr>
											...
											<td style="text-align:left;font-size:11px !important;font-weight:normal;padding-left:3px !important;">';echo $vrdetail[0]['vrdate'];;echo '</td>
										</tr>
										<tr>
										...
										<tr>
											<td style=" width: 120px; text-align:left; font-size:12px !important;padding-left:18px !important;font-weight:bolder;" >Date:</td>
											<td style="text-align:left;font-size:11px !important;font-weight:normal;padding-left:3px !important;">';echo substr($vrdetail[0]['edate'],0,10);;echo '</td>
										</tr>
										<tr>
...
;echo '</td>
											...
											<td style="text-align:left;" style="font-size:18px !important;">';echo substr($vrdetail[0]['lc_date'],0,10);;echo '</td>
										</tr>
										<!--  -->
										<tr>
											<td style="text-align:left; " colspan="2">';
...
;echo '</td>
										...
										<tr >
											...
											<td colspan=\'5\' style=" width: 100px !important; text-align:left; font-size:9px; "></td>
										</tr>
										<!-- <tr >
...
endforeach;echo '							</tbody>
							<tfoot>
								<tr class="foot-comments">
									<td class="subtotalend bold-td text-right" colspan="1">Container No:<br/> ';echo $vrdetail[0]['container_no'];;echo '</td>
