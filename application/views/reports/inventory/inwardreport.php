...
echo '<script id="general-head-template" type="text/x-handlebars-template">
    <tr>
        ...
        <th class="no_sort" style="width: 60px;">Vr# </th>
        <th class="no_sort" style="width: 80px;">IGP/OGP# </th>
        <th class="no_sort">Party Name </th>
        <th class="no_sort">Item </th>
        <th class="no_sort" style="width: 80px;">UOM </th>
        <th class="no_sort">Department </th>
        <th class="no_sort" style="width: 80px;">Wo# </th>
        <th class="no_sort " >Remarks </th>
        <th class="no_sort"style="width: 80px;">Qty </th>
        <th class="no_sort" style="width: 80px;">Weight </th>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="pull-right">
                                                ...
                                                <!-- <a href=\'\' class="btn btn-sm btn-default " id="btnPrint"><i class="fa fa-print"></i>Print F9</a>
                                                    <a href=\'\' class="btn btn-sm btn-default " id="btnPrint2"><i class="fa fa-print"></i>Pdf F8</a> -->
                                                    <div class="btn-group">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <a href=\'\' class="btn btn-default btn-sm btnSelCre">Party</a>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        <label class="radio-inline">
                                                            <input type="radio" name="rbRpt" id="Radio3" value="all" checked="checked">
                                                            All
                                                        </label>
                                                        <label class="radio-inline">
                                                            <input type="radio" name="rbRpt" id="Radio1" value="returnable" >
                                                            Returnable
                                                        </label>
                                                        <label class="radio-inline">
                                                            <input type="radio" name="rbRpt" id="Radio2" value="nonreturnable">
                                                            Non Returnable
                                                        </label>
                                                  ...
                                                  <div class="panel-body">
                                                    <form class="form-group">
                                                        <div class="row">
                                                            ...
                                                            ';}else{;echo '	
                                                              ...
                                                              <div class="col-lg-3">                                                
                                                                  <label>Warehouse</label>
                                                                  <select  class="form-control input-sm select2" multiple="true" id="drpdepartId" data-placeholder="Choose Item....">
                                                                    <option value="';echo $did;;echo'" selected="';echo $did;;echo'">';echo $department['name'];;echo '</option>
                                                                    </select>                            
                                                                </div>
                                                            ';};echo '
                                                       ...
                                                       <div class="col-lg-3" >
                                                        ...
                                                        <select  class="form-control input-sm select2" multiple="true" id="drpStaffType" data-placeholder="Choose Staff Type....">
