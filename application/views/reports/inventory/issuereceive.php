...
echo '<script id="general-head-template" type="text/x-handlebars-template">
    <tr>
        ...
        <th class="no_sort" style="width: 200px;">UOM </th>
        <th class="no_sort" style="width: 200px;">Work Order </th>
...
<script id="general-head-template-is" type="text/x-handlebars-template">
    <tr>
        <th class="no_sort" style="width: 50px;">Sr#</th>
        <th class="no_sort" style="width: 900px;">Party </th>
        <th class="no_sort" style="width: 900px;">Description </th>
...
<div id="main_wrapper">
    ...
    <div class="page_bar">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page_title">Vendor Stock Report</h1>
            </div>
        </div>
    </div>
