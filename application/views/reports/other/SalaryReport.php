...
echo '<script id="general-head-template-summary" type="text/x-handlebars-template">
    <tr>
        <th class="no_sort" style="width: 10px;"># </th>
        <th class="no_sort" style="width: 90px;">Description </th>
        <th class="no_sort text-right" style="width: 30px;">NOE </th>
        <th class="no_sort text-right" style="width:40px;">Basic Salary </th>
        <th class="no_sort text-right" style="width:40px;">OverTime </th>
        <th class="no_sort text-right" style="width:40px;">G Salary </th>
        <th class="no_sort text-right" style="width:40px;">Advance </th>
        <th class="no_sort text-right" style="width:40px;">Loan </th>
        <th class="no_sort text-right"style="width: 40px;" >Incentive </th>
        <th class="no_sort text-right"style="width: 40px;" >NetSalary </th>
        
    </tr>
</script>
<script id="voucher-item-template-summary" type="text/x-handlebars-template">
  <tr>
     <td>{{SERIAL}}</td>
     <td>{{VOUCHER}}</td>
     <td class="text-right">{{{NOE}}}</td>
     <td class="text-right">{{BSALARY}}</td>
     <td class="text-right">{{OVERTIME}}</td>
     <td class="text-right">{{GSALARY}}</td>
...
<script id="general-head-template" type="text/x-handlebars-template">
    <tr>
        <th class="no_sort" style="width:10px;"># </th>
        <th class="no_sort" style="min-width:5px !important; width:20px !important;" >Date </th>
        <th class="no_sort" style="width: 10px;">Vr# </th>
        <th class="no_sort" style="width:10px;">Id </th>
        <th class="no_sort" style="width:60px;">Employee </th>
        <th class="no_sort" style="width:30px;">FName </th>
        <th class="no_sort" style="width:30px;">Designation </th>
        <th class="no_sort" style="width:60px;">Department </th>
        <th class="no_sort text-right"style="width: 20px;" >Basic </th>
        <th class="no_sort text-right"style="width: 20px;" >Paid Days </th>
        <th class="no_sort text-right" style="width: 20px;">Salary</th>
        <th class="no_sort text-right" style="width: 20px;">Ot Hour</th>
        <th class="no_sort text-right" style="width: 20px;">Ot Rate </th>
        <th class="no_sort text-right" style="width: 20px;">Ot Amount </th>
        <th class="no_sort text-right" style="width: 20px;">Incentive </th>
        <th class="no_sort text-right" style="width: 20px;">G Salary </th>
        <th class="no_sort text-right" style="width: 20px;">Advance </th>
        <th class="no_sort text-right" style="width: 20px;">Loan </th>
        <th class="no_sort text-right" style="width: 20px;">Net Salary </th>
    </tr>
</script>
<script id="voucher-item-template" type="text/x-handlebars-template">
  <tr>
     ...
     <td>{{DEPT_NAME}}</td>
     <td class="text-right">{{BSALARY}}</td>
     <td class="text-right">{{PAID_DAYS}}</td>
     <td class="text-right">{{GSALARY1}}</td>
     <td class="text-right">{{OTHOUR}}</td>
     <td class="text-right">{{OTRATE}}</td>
     <td class="text-right">{{OTMAOUNT}}</td>
     <td class="text-right">{{INCENTIVE}}</td>
     <td class="text-right">{{GSALARY2}}</td>
     <td class="text-right">{{ADVANCE}}</td>
     <td class="text-right">{{LOAN}}</td>
     <td class="text-right">{{NET_SALARY}}</td>
  </tr>
...
<script id="voucher-sum-template" type="text/x-handlebars-template">
  <tr class="finalsum">
     ...
     <td class="text-right"colspan="">{{BSALARY}}</td>
     <td class="text-right"colspan="">{{PAIDDAYS}}</td>
     <td class="text-right"colspan="">{{GSALARY1}}</td>
     <td class="text-right"colspan="">{{OTHOUR}}</td>
     <td class="text-right"colspan=""></td>
     <td class="text-right"colspan="">{{OTMAOUNT}}</td>
     <td class="text-right"colspan="">{{INCENTIVE}}</td>
     <td class="text-right"colspan="">{{GSALARY2}}</td>
     <td class="text-right"colspan="">{{ADVANCE}}</td>
     <td class="text-right"colspan="">{{LOAN}}</td>
     <td class="text-right"colspan="">{{NET_SALARY}}</td>
...
<div id="main_wrapper">
    ...
    <div class="page_bar">
        <div class="row">
            <div class="col-md-12">
                 ';if ($etype == 'salary'){;echo ' 
                    <h1 class="page_title" style="text-transform:capitalize;">';echo 'Salary Sheet Report';;echo '</h1>
                ';}else{;echo '                    <h1 class="page_title" style="text-transform:capitalize;">';echo 'Wages Sheet Report';;echo '</h1>
                ';};echo '            </div>
        </div>
    </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <a href=\'\' class="btn btn-default btn-sm btnSelCre">Designation Wise</a>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        ...
                                                                        <select  class="form-control input-sm select2" multiple="true" id="drpdepartId" data-placeholder="Choose Department....">
                                                                           <!-- <option></option> -->
