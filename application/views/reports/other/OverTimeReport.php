...
echo '<script id="general-head-template" type="text/x-handlebars-template">
    <tr>
        ...
        <th class="no_sort" style="width: 150px;">Remarks </th>
        <th class="no_sort" style="width: 60px;">Ot Hour</th>
    </tr>
</script>
...
<div id="main_wrapper">
    ...
    <div class="page_bar">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page_title" style="text-transform:capitalize;"> Over Time Report </h1>
            </div>
        </div>
    </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <a href=\'\' class="btn btn-default btn-sm btnSelCre">Approved Wise</a>
