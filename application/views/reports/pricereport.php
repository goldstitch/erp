					...
					<div class="row-fluid relative">
						<div class="span12">
								...
								<div class="block pull-center" style="width:280px !important; float: center; display:inline !important;">
									<h3 class="invoice-type text-center" style="border:none !important; margin: 0px !important; position: center; top: 18px !important; ">Price Report</h3>
								</div>
						</div>
					</div>
					<br>
					...
					<thead>
						<tr>
							...
							<th style=" width: 10px; text-align:left;">Sr#</th>
									...
									<th style=" width: 20px; text-align:left;">Item_id</th>
									<th style=" width: 40px; text-align:left; ">Item_Name</th>
									<th style=" width: 30px; text-align:left;">Wholesale Price</th>
									<th style=" width: 30px; text-align:left;">Retail Price</th>
