						...
						<table class="voucher-table">
							<thead>
								<tr>
									...
									<th class="text-left" style=" width: 40px; ">Cheq Date</th>
									<th class="text-left" style=" width: 100px; ">Account</th>
									<th class="text-left" style=" width: 100px; ">Remarks</th>
									<th style=" width: 20px; ">Inv#</th>
									<th style=" width: 30px; ">Cheq#</th>
