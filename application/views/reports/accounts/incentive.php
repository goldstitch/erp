...
<div id="main_wrapper">
	...
	<div class="page_bar">
		<div class="row">
			<div class="col-md-12">
				<h1 class="page_title">Incentive Report</h1>
			</div>
		</div>
	</div>
								...
								<div class="col-lg-4">
									<div class="input-group">
										...
										<select class="form-control" id="name_dropdown">
											<option value="-1" selected="">All</option>
		                                	';foreach ($staffs as $staff): ;echo '	                                          	<option value="';echo $staff['pid'];;echo '">';echo $staff['name'];;echo '</option>
	                                      	';endforeach ;echo '		                                </select>
									</div>
								</div>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<table class="table table-striped table-hover ar-datatable" id="report-table">
								<thead>
									<tr>
										<th>Sr#</th>
										<th>Vr#</th>
