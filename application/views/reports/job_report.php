				...
				<div class="span12 centered">
					...
					<div class="row-fluid relative">
						<div class="span12">
								...
								<div class="block pull-center" style="width:280px !important; float: center; display:inline !important;">
									<h3 class="invoice-type text-center" style="border:none !important; margin: 0px !important; position: center; top: 18px !important; ">Job Report</h3>
								</div>
						</div>
					</div>
					<br>
					...
					<thead>
						<tr>
							...
							<th style=" width: 50px; text-align:left;">Job Detail</th>
							<th style=" width: 20px; text-align:left;">Cost</th>
							<th style=" width: 20px; text-align:left;">Start date</th>
							<th style=" width: 20px; text-align:left;">End date</th>
							<th style=" width: 20px; text-align:left;">Finish date</th>
							<th style=" width: 20px; text-align:left;">Receive</th>
							<th style=" width: 20px; text-align:left;">Balance</th>
							<th style=" width: 20px; text-align:left;">Status</th>
						</tr>
					</thead>
					<tbody>
					';if (count($item) >0): ;echo '													';$counter = 1;foreach ($item as $items): ;echo '	
					   <tr class="item-row">
								...
								<td>';echo $items['id'];;echo'</td>
								<td>';echo $items['job_detail'];;echo '</td>
								<td>';echo $items['amount'];;echo'</td>
								<td>';echo $items['start_date'];;echo '</td>
								<td>';echo $items['end_date'];;echo '</td>
								<td>';echo $items['finish_date'];;echo'</td>
								<td>';echo $items['receive'];;echo'</td>
								<td>';echo $items['balance'];;echo'</td>
								<td>';echo $items['status'];;echo '</td>
								</tr>
