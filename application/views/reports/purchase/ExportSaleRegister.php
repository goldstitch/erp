...
<!-- Sale -->
    <script id="generalsale-head-template" type="text/x-handlebars-template">
        <tr>
            ...
            <th class="no_sort" style="width: 30px;">Date </th>
            <th class="no_sort" style="width: 20px;">Vr# </th>
            <th class="no_sort" style="width:30px;">Art# </th>
            <th class="no_sort" style="width:70px;">Item </th>
            <th class="no_sort" style="width:30px;">Ctn </th>
            <th class="no_sort" style="width: 30px;">Dozen </th>
            <th class="no_sort" style="width: 30px;">Per/Ctn </th>
            <th class="no_sort" style="width: 30px;">Currencey </th>
            <th class="no_sort" style="width: 30px;">FRate </th>
            <th class="no_sort" style="width: 30px;">FAmount </th>
            <th class="no_sort" style="width: 30px;">Rate </th>
            <th class="no_sort" style="width: 40px;">Amount </th>
            <th class="no_sort" style="width: 50px; ">Party </th>
            <th class="no_sort" style="width: 30px; ">Country </th>
            <th class="no_sort" style="width: 30px; ">Due Date </th>
            <th class="no_sort" style="width: 30px; ">Rcv Date </th>
            <th class="no_sort" style="width: 30px; ">Rcv Amount </th>
            <th class="no_sort" style="width: 30px; ">Difference </th>
        </tr>
    </script>
    ...
    <script id="vouchersale-item-template" type="text/x-handlebars-template">
      <tr>
         ...
         <td>{{CURRENCY}}</td>
         <td class="text-right" style="text-align:right !important;">{{FRATE}}</td>
         <td class="text-right" style="text-align:right !important;">{{FAMOUNT}}</td>
         <td class="text-right" style="text-align:right !important;">{{RATE}}</td>
         <td class="text-right" style="text-align:right !important;">{{AMOUNT}}</td>
         <td>{{NAME}}</td>
         <td class="text-right" style="text-align:right !important;">{{COUNTRY}}</td>
         <td  style="text-align:right !important;">{{DDATE}}</td>
         <td  style="text-align:right !important;">{{RCV_DATE}}</td>
         <td class="text-right" style="text-align:right !important;">{{RCV_AMOUNT}}</td>
         <td class="text-right" style="text-align:right !important;">{{DIFFERENCE}}</td> 
      </tr>
    </script>
    ...
    <script id="vouchersale-sum-template" type="text/x-handlebars-template">
      <tr class="finalsum">
         ...
         <td></td>
         <td class="tblInvoice"></td>
         <td class="text-right txtbold">{{ FAMOUNT }}</td>
         <td></td>
         <td class="text-right txtbold" style="text-align:right !important;">{{ VOUCHER_SUM }}</td>
         <td></td>
         <td></td>
         <td></td>
         <td></td>
         <td style="text-align:right !important;">{{ RCV_AMOUNT }}</td>
         <td style="text-align:right !important;">{{ DIFFERENCE }}</td>
...
<div id="main_wrapper">
    ...
    <div class="page_bar">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page_title">';echo 'Sale Register';;echo '</h1>
            </div>
        </div>
    </div>
