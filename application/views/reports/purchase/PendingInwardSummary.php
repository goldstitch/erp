...
echo '<script id="general-head-template" type="text/x-handlebars-template">
  <tr>
    <th class="no_sort text-center" style="width: 10px; ">Sr# </th>
    <th class="no_sort text-center" style="width: 30px; " >Vr#</th>
    <th class="no_sort text-center" style="width: 30px; " >Date</th>

    <th class="no_sort text-center" style="width: 30px; ">Party </th>
    <th class="no_sort text-left" style="width:200px;">Item </th>
    <th class="no_sort text-center" style="width:30px;">Uom </th>
    <th class="no_sort text-center" style="width:30px;">Model </th>
    <th class="no_sort text-right" style="width: 30px;">GpQty </th>
    <th class="no_sort text-right" style="width: 30px;">BillQty</th>
    <th class="no_sort text-right" style="width: 30px;">Balance</th>
    <th class="no_sort text-right hide" style="width: 30px;">Rate </th>
    <th class="no_sort text-right hide" style="width: 30px;">Amount </th>
    
    <th class="no_sort text-right " style="width: 30px;">RecVr# </th>
    <th class="no_sort text-right " style="width: 30px;">RecDate </th>
...
<script id="voucher-item-template" type="text/x-handlebars-template">
  <tr>
   ...
   <td class="text-center"><a target="_blank" href={{HREFF}}>{{orderno}}</a></td>
   <td class="text-center">{{{party_name}}}</td>
   <td class="text-center">{{{vrdate}}}</td>

   <td class="text-left">{{item_des}}</td>
   <td class="text-center">{{uom}}</td>
   <td class="text-center">{{model}}</td>
   <td class="text-right">{{orderqty}}</td>
   <td class="text-right">{{purqty}}</td>
   <td class="text-right">{{balqty}}</td>
   <td class="text-right hide" style="text-align:right !important;">{{rate}}</td>
   <td class="text-right hide" style="text-align:right !important;">{{amount}}</td>
   <td class="text-center"><a target="_blank" href={{HREFF2}}>{{rec_vrnoa}}</a></td>
...
<script id="voucher-sum-template" type="text/x-handlebars-template">
  <tr class="hightlight_tr">
   ...
   <td class="text-right">{{PURQTY}}</td>
   <td class="text-right">{{BALQTY}}</td>
   <td class="text-right hide" style="text-align:right !important;"></td>
   <td class="text-right hide" style="text-align:right !important;">{{AMOUNT}}</td>
                ...
                <div class="panel-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-3">
                      <div class="form-group">
                        <label class="radio-inline">
                          <input type="radio" name="rbRptReportType" id="Radio1" value="pending" checked="checked">
                          Pending
                        </label>
                        <label class="radio-inline">
                          <input type="radio" name="rbRptReportType" id="Radio2" value="completed">
                          Completed
                        </label>
                        <label class="radio-inline">
                          <input type="radio" name="rbRptReportType" id="Radio3" value="all">
                          All
                        </label>
                    ...
                    <div class="col-lg-2">
                      ...
                      <div class="input-group">
                        <span class="input-group-addon VoucherNoLable">Type</span>
                      <select class="form-control" id="orderType_dropdown" >

                        <option value="pur_order" selected="" >General Purchase</option>
                        <option value="yarnPurchaseContract" >Yarn Purchase</option>
                        <option value="fabricPurchaseContract" >Fabric Purchase</option>
                          ...
                          <div class="pull-right">
                            <ul class="stats">
                              <li class=\'blue\'>
                                ...
                                <div class="details">
                                  <span class="big grand-total">0</span>
