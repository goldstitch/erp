...
echo '<script id="general-head-template" type="text/x-handlebars-template">
    <tr>
        ...
        <th class="no_sort" style="width: 100px;">Color </th>
        ...
        <th class="no_sort" style="width: 100px;">L Stock </th>
    </tr>
</script>
<script id="summary-head-template" type="text/x-handlebars-template">
    <tr>
        ...
        <th class="no_sort">Color </th>
        <th class="no_sort">Qty </th>
        <th class="no_sort">Rate </th>
        <th class="no_sort">Account </th>
        <th class="no_sort">Stock </th>
    </tr>
</script>
<script id="summary-godownhead-template" type="text/x-handlebars-template">
    <tr>
        ...
        <th class="text-right" style="width: 150px;" >Color </th>
        <th class="text-right" style="width: 150px;" >Qty </th>
        <th class="text-right" style="width: 100px;">Rate </th>
        <th class="text-right" style="width: 150px;" >Amount </th>
        <th class="text-right" style="width: 150px;">L Stock </th>
        <th class="text-right" style="width: 150px;">Vendor </th>
    </tr>
</script>
...
<script id="voucher-item-template" type="text/x-handlebars-template">
  <tr>
     ...
     <td class="text-right" style="text-align:right !important;">{{RATE}}</td>
     <td class="text-right" style="text-align:right !important;">{{LVENDOR}}</td>
     <td class="text-right" style="text-align:right !important;">{{LSTOCK}}</td>
  </tr>
</script>
...
<script id="voucher-sum-template" type="text/x-handlebars-template">
  <tr class="finalsum">
     ...
     <td class="text-right txtbold" style="text-align:right !important;"></td>
