...
<div id="main_wrapper">
    ...
    <div class="page_bar">
        <div class="row">
            <div class="col-md-3">
                <h1 class="page_title">General Contract </h1>
            </div>
            <div class="col-lg-9">
                <a class="btn btn-sm btn-default btnReset"><i class="fa fa-refresh"></i> Reset F5</a>
                <a class="btn btn-sm btn-default btnSave" data-savegodownbtn=\'';echo $vouchers['warehouse']['insert'];;echo '\' data-saveaccountbtn=\'';echo $vouchers['account']['insert'];;echo '\' data-saveitembtn=\'';echo $vouchers['item']['insert'];;echo '\' data-insertbtn=\'';echo $vouchers['glovecontract']['insert'];;echo '\' data-updatebtn=\'';echo $vouchers['glovecontract']['update'];;echo '\' data-deletebtn=\'';echo $vouchers['glovecontract']['delete'];;echo '\' data-printbtn=\'';echo $vouchers['glovecontract']['print'];;echo '\' ><i class="fa fa-save"></i> Save F10</a>
                                            ...
                                            <form action="">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-2">                                                
                                                        ...
                                                        <select class="form-control input-sm" id="InvType_dropdown">
                                                            ...
                                                            <option value="Raising"  selected="">Raising</option>
                                                            <option value="Calander"  selected="">Calander</option>
                                                        </select>                                               
                                                    </div>
                                                </div>
                                                ...
                                                <div class="container-wrap">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4" >
                                                            <label for="" id="stqty_lbl">Consumed Item</label>
                                                            <div class="input-group" >
