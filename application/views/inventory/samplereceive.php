...
<div id="main_wrapper">
  ...
  <div class="page_bar">
    <div class="row">
      <div class="col-md-4">
        <h1 class="page_title">Sample Receive Voucher</h1>
      </div>
      <div class="col-lg-8">
                  ...
                  <div class="tab-pane active fade in" id="Main">
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="panel panel-default">
                          <div class="panel-body">
                            ...
                            <form action="">
                              ...
                              <input type="number" class="form-control" id="sample_id">
                            </div>

                              <div class="col-lg-2">
                              <label>Sample Material Issue Id</label>
                              <input type="number" class="form-control" id="job_id">
                            </div>
                        ...
                        <div class="col-lg-3">
                          ...
                          <input type="text" class="form-control" id="issue" readonly="">
                                ...
                                <div class="container-wrap">
                                  ...
                                  <h4>Finished Material Detail</h4>
                                  ...
                                  <h4>Consumed Material Detail</h4>

                                    <div class="row">
                                    <div class="col-lg-12">
                                      <div id="no-more-tables">
                                        <table class="table table-striped table-bordered" id="purchase_table2">
                                          <thead class="cf tbl_thead">
                                            <tr>
                                              <th data-title=\'Sr#\'>Sr#</th>
                                              <th data-title=\'Description\'>Item Name</th>
                                ...
                                <h4>Remaining Material Detail</h4>

                                <div class="row">
                                <div class="col-lg-12">
                                  <div id="no-more-tables">
                                    <table class="table table-striped table-bordered" id="purchase_table3">
                                      <thead class="cf tbl_thead">
                                        <tr>
                                          <th data-title=\'Sr#\'>Sr#</th>
                                          <th data-title=\'Description\'>Item Name</th>
                                          ...
                                          <th data-title=\'UOM\'>UOM</th>
                                          <th data-title=\'Weight\' style=\'text-align:right;\'>Qty</th>
                                          <th data-title=\'Weight\' style=\'text-align:right;\'>Received</th>
                                          <th data-title=\'To\'>Location To</th>
                                          <th data-title=\'Action\'>Action</th>
                                        </tr>
                                      </thead>
                        ...
                        <div class="col-md-2">
                          <div class="row">
                            <label>Material Issued Per Sample</label>
                            <table class="table table-striped Lstocks_table2 font_tbl">
                              <thead>
                                <tr>
                                  <th>Material</th>
                        ...
                        <div class="row">
                        <label>Material Required Per Sample</label>
                        <table class="table table-striped Lstocks_table3 font_tbl">
                          <thead>
                            <tr>
                              <th>Material</th>
                              <th class="text-right">Qty</th>
