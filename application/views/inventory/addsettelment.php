...
<div id="main_wrapper">
    ...
    <div class="page_bar">
        <div class="row">
            <div class="col-md-4">
                <h1 class="page_title"> Settelment Stitcher</h1>
            </div>
            <div class="col-lg-8">
                <a class="btn btn-sm btn-default btnReset"><i class="fa fa-refresh"></i> Reset F5</a>
                <a class="btn btn-sm btn-default btnSave" data-savegodownbtn=\'';echo $vouchers['warehouse']['insert'];;echo '\' data-saveaccountbtn=\'';echo $vouchers['account']['insert'];;echo '\' data-saveitembtn=\'';echo $vouchers['item']['insert'];;echo '\' data-insertbtn=\'';echo $vouchers['rejectionvendorsvoucher']['insert'];;echo '\' data-updatebtn=\'';echo $vouchers['rejectionvendorsvoucher']['update'];;echo '\' data-deletebtn=\'';echo $vouchers['rejectionvendorsvoucher']['delete'];;echo '\' data-printbtn=\'';echo $vouchers['rejectionvendorsvoucher']['print'];;echo '\' ><i class="fa fa-save"></i> Save F10</a>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-2">
                                                        <!-- <div class="input-group"> -->
                                                            ...
                                                            <input type="hidden" id="tankaid" value="';echo $setting_configur[0]['tanka'];;echo '">
                                            ...
                                            <div class="row">                                    
                                               <div class="col-lg-2">                                                
                                                ...
                                                <div class="col-lg-2">                                                
                                                    ...
                                                    <input class="form-control input-sm" type="date" id="bilty_date" value="';echo date('Y-m-d');;echo '">                                                
                                                </div> 
                                                
                                                <div class="col-lg-1">
                                                    <label>?</label>
                                                    <a href=\'\' class="btn btn-sm btn-success btnGetData" id="btnGetData" ><i class="fa fa-search"></i> Get</a>
                                                </div>
                                                <div class="col-lg-1">                                                    
                                                    <label>Opening</label>
                                                    <input type="text" class=" form-control num"  id="txtOpening" style=\'text-align:right;\'>
                                                </div>                                                
                                                <div class="col-lg-1">                                                    
                                                    <label>In</label>
                                                    <input type="text" class=" form-control num"  id="txtIn" style=\'text-align:right;\'>
                                                </div> 
                                                  <div class="col-lg-1">                                                    
                                                    <label>Out</label>
                                                    <input type="text" class=" form-control num"  id="txtOut" style=\'text-align:right;\'>
                                                </div>                                                
                                                <div class="col-lg-1">                                                    
                                                    <label>Balance</label>
                                                    <input type="text" class=" form-control num"  id="txtBalance" style=\'text-align:right;\'>
                                                </div>
                                                <div class="col-lg-2">                                                    
                                                    <label>Amount</label>
                                                    <input type="text" class=" form-control num"  id="txtStichAmount" style=\'text-align:right;\'>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-1">                                                    
