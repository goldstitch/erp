...
<div id="main_wrapper">
    ...
    <div class="page_bar">
        <div class="row">
            <div class="col-md-3">
                <h1 class="page_title">Stitcher Contract </h1>
            </div>
            <div class="col-lg-9">
                <a class="btn btn-sm btn-default btnReset"><i class="fa fa-refresh"></i> Reset F5</a>
                <a class="btn btn-sm btn-default btnSave" data-savegodownbtn=\'';echo $vouchers['warehouse']['insert'];;echo '\' data-saveaccountbtn=\'';echo $vouchers['account']['insert'];;echo '\' data-saveitembtn=\'';echo $vouchers['item']['insert'];;echo '\' data-insertbtn=\'';echo $vouchers['stitchingcontract']['insert'];;echo '\' data-updatebtn=\'';echo $vouchers['stitchingcontract']['update'];;echo '\' data-deletebtn=\'';echo $vouchers['stitchingcontract']['delete'];;echo '\' data-printbtn=\'';echo $vouchers['stitchingcontract']['print'];;echo '\' ><i class="fa fa-save"></i> Save F10</a>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <form action="">
                                                ...
                                                <div class="container-wrap">
                                                        ...
                                                        <div class="col-lg-2">                                                
                                                            <label>Phase To</label>
                                                            <select class="form-control select2" id="phase_dropdown_To">
                                                                <option value="" selected="" disabled="">Phase</option>
                                                                ';foreach ($phase as $phases): ;echo '                                                                    <option value="';echo $phases['id'];;echo '">';echo $phases['name'];;echo '</option>
                                                                ';endforeach ;echo '                                                            </select>                                          
                                                        </div>
                                                        ...
                                                        <table class="col-lg-12 table-bordered table-striped table-condensed cf" id="purchase_table">
                                                            <thead class="cf tbl_thead">
                                                                <tr>
                                                                    ...
                                                                    <th class="numeric" style=\'text-align:right;\'>Req Wt</th>
