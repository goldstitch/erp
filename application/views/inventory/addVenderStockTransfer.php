...
<div class="page_bar">
    <div class="row">
        <div class="col-md-3">
            <h1 class="page_title">Vendor Stock Transfer</h1>
        </div>
        <div class="col-lg-9">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <form action="">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-2">
                                                        <div class="input-group">
                                                            <span class="input-group-addon txt-addon">Contract#</span>                                                
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="input-group">          
                                                            <span class="input-group-addon txt-addon ">DueDate</span>                                      
                                                ...
                                                <div class="row">
                                                  ...
                                                  <div class="col-lg-4" >
                                                    <label for="">Received Stock Party<img id="imgPartyLoader" class="hide" src="';echo base_url('assets/img/loader.gif');;echo '">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style ="    font-size: 16px !important;"id="partyBalance"></span></label>
                                                ...
                                                <div class="col-lg-4" >
                                                    <label for="">Consumed Stock Party <img id="imgPartyConsLoader" class="hide" src="';echo base_url('assets/img/loader.gif');;echo '">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style ="    font-size: 16px !important;"id="partyConsBalance"></span></label>


                                                    <input type="text" class="form-control" id="txtPartyConsId" tabindex="2">
                                                    <input id="hfPartyConsId" type="hidden" value="" />
                                                    <input id="hfPartyConsBalance" type="hidden" value="" />
                                                    <input id="hfPartyConsCity" type="hidden" value="" />
                                                    <input id="hfPartyConsAddress" type="hidden" value="" />
                                                    <input id="hfPartyConsCityArea" type="hidden" value="" />
                                                    <input id="hfPartyConsMobile" type="hidden" value="" />
                                                    <input id="hfPartyConsUname" type="hidden" value="" />
                                                    <input id="hfPartyConsLimit" type="hidden" value="" />
                                                    <input id="hfPartyConsName" type="hidden" value="" />
                                            ...
                                            <div class="row">
                                                ...
                                                <legend style="color: blue;">Received Items Detail</legend>
                                                        ...
                                                        <table class="col-lg-12 table-bordered table-striped table-condensed cf" id="purchase_table">
                                                            ...
                                                            <tfoot class="tfoot_tbl">
                                                                <tr>
                                                                    ...
                                                                    <td  class="text-right" id="txtTotalWeight"></td>                                   
                                            ...
                                            <legend style="color: red;">Consumed Items Detail</legend>
                                            ...
                                            <div class="container-wrap">
                                                ...
                                                <div class="row">     
                                                    ...
                                                    <div class="col-lg-4">
                                                      <label for="">Consume Item<img id="imgItemReceiveLoader" 
                                                        class="hide" src="';echo base_url('assets/img/loader.gif');;echo '"></label>
                                                ...
                                                <div class="col-lg-1">
                                                    <label for="">Rate</label>                                                    
                                                    <input type="text" class="form-control num" id="txtConsPRate">                                                    
                                                </div>
