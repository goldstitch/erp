...
<div id="main_wrapper">
    ...
    <div class="page_bar">
        <div class="row">
            <div class="col-md-4">
                <h1 class="page_title">Issuance Voucher</h1>
            </div>
            <div class="col-lg-8">
                <a class="btn btn-default btnReset"><i class="fa fa-refresh"></i> Reset F5</a>
                <a class="btn btn-sm btn-default btnSave" data-saveaccountbtn=\'';echo $vouchers['account']['insert'];;echo '\' data-saveitembtn=\'';echo $vouchers['item']['insert'];;echo '\' data-insertbtn=\'';echo $vouchers['consumptionvoucher']['insert'];;echo '\' data-updatebtn=\'';echo $vouchers['consumptionvoucher']['update'];;echo '\' data-deletebtn=\'';echo $vouchers['consumptionvoucher']['delete'];;echo '\' data-printbtn=\'';echo $vouchers['consumptionvoucher']['print'];;echo '\' ><i class="fa fa-save"></i> Save F10</a>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-2">
                                                            <div class="input-group">
                                                                ...
                                                                <span class="input-group-addon txt-addon VoucherNoLable">Cons#</span>
