                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-3">
                                                        <!-- <div class="input-group"> -->
                                                            ...
                                                            <input class="form-control input-sm  ts_datepicker" type="text" id="current_date">
                                                        <!-- </div> -->
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                   ...
                                                   <!--  <div class="col-lg-3">
                                                    ...
                                                    <div class="col-lg-6" >
                                                            ...
                                                            <div class="input-group" >
                                                            <select class="form-control select2" id="party_dropdownReceuive" >
                                                ...
                                                <div class="row">
                                                 <div class="col-lg-2">                                                
                                                    ...
                                                    <div class="col-lg-2">                                                
                                                        ...
                                                        <input class="form-control input-sm  ts_datepicker" type="text" id="due_date">                                                
                                                    </div>                                           
                                                    <div class="col-lg-1">                                                
                                                        <label>WO#</label>
