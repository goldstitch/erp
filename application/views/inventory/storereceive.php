...
<div id="main_wrapper">
  ...
  <div class="page_bar">
    <div class="row">
      <div class="col-md-4">
        <h1 class="page_title">Store Receive Voucher</h1>
      </div>
      <div class="col-lg-8">
                        ...
                        <div class="col-lg-3">
                          ...
                          <input type="text" class="form-control" id="issue" readonly="">
				                 ...
				                 <div class="col-lg-2">
                                  ...
                                  <div class="col-lg-2">
                                  <label>Job QTY</label>
                                  <input type="number" class="form-control" id="job_qty">
                                </div>
                                  ...
                                  <input type="text" class="form-control" id="txtjob" readonly="">
                                </div>
                                </div>
