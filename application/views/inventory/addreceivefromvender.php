...
<div class="page_bar">
    <div class="row">
        <div class="col-md-3">
            <h1 class="page_title"> Receive From Vendor</h1>
        </div>
        <div class="col-lg-9">
            <a class="btn btn-sm btn-default btnReset"><i class="fa fa-refresh"></i> Reset F5</a>
            <a class="btn btn-sm btn-default btnSave" data-savegodownbtn=\'';echo $vouchers['warehouse']['insert'];;echo '\' data-saveaccountbtn=\'';echo $vouchers['account']['insert'];;echo '\' data-saveitembtn=\'';echo $vouchers['item']['insert'];;echo '\' data-insertbtn=\'';echo $vouchers['reveivefromvendor']['insert'];;echo '\' data-updatebtn=\'';echo $vouchers['reveivefromvendor']['update'];;echo '\' data-deletebtn=\'';echo $vouchers['reveivefromvendor']['delete'];;echo '\' data-printbtn=\'';echo $vouchers['reveivefromvendor']['print'];;echo '\' ><i class="fa fa-save"></i> Save F10</a>
                                            ...
                                            <form action="">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-1 amnt_width" >
                                                        ...
                                                        <input type="text" class="form-control readonly num" id="txtWastagePercent" readonly="true" tabindex="-1">                                                    
                                                    </div>
                                                        ...
                                                        <table class="col-lg-12 table-bordered table-striped table-condensed cf" id="purchase_table">
                                                            <thead class="cf tbl_thead">
                                                                <tr>
                                                                    ...
                                                                    <th class="text-right">GrWeight</th>
                                                                    <th class="text-right">NetWeight</th>
    ...
    <div class="modal-dialog modal-lg">
      ...
      <div class="row">
         <div class="col-lg-3" >
            ...
            <select class="form-control input-sm select2" multiple="true" id="article_dropdown">
