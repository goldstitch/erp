  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3 id="myModalLabel">Vendor Stock Detail</h3>
      </div>
  ...
  <div id="party-lookup" class="modal fade modal-lookup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div id="item-lookup" class="modal fade modal-lookup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      ...
      <div class="page_bar">
        <div class="row">
          <div class="col-md-5">
            <h1 class="page_title">Vendor Stock Transfer Voucher</h1>
          </div>
          <div class="col-lg-4">
            <a class="btn btn-sm btn-default btnReset"><i class="fa fa-refresh"></i> Reset F5</a>
            <a class="btn btn-sm btn-default btnSave" data-savegodownbtn=\'';echo $vouchers['warehouse']['insert'];;echo '\' data-saveaccountbtn=\'';echo $vouchers['account']['insert'];;echo '\' data-saveitembtn=\'';echo $vouchers['item']['insert'];;echo '\' data-insertbtn=\'';echo $vouchers['transfervendor']['insert'];;echo '\' data-updatebtn=\'';echo $vouchers['transfervendor']['update'];;echo '\' data-deletebtn=\'';echo $vouchers['transfervendor']['delete'];;echo '\' data-printbtn=\'';echo $vouchers['transfervendor']['print'];;echo '\' ><i class="fa fa-save"></i> Save F10</a>
            ...
            <div class="btn-group">
              ...
              <ul class="dropdown-menu" role="menu">
                <li ><a href="#" class="btnPrint">With header</a></li>
                          ...
                          <div class="panel-body">
                            ...
                            <form action="">
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-6" >
                                  <label>Issue Party</label>

                                  <select class="form-control select2" id="party_dropdown11" >
                                    <option value="" disabled="" selected="">Issue party</option>
                                ...
                                <div class="col-lg-6" >
                                  ...
                                  <select class="form-control select2" id="party_dropdownReceive" >
                                    <option value="" disabled="" selected="">Receive party</option>
                                    ';foreach ($parties as $party): ;echo '                                      <option value="';echo $party['pid'];;echo '">';echo $party['name'];;echo '</option>
                                    ';endforeach ;echo '                                  </select>
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-3">                                                
                                  ...
                                  <div class="col-lg-3" >
                                    <label for="">Expense Account<img id="imgPartyLoader" class="hide" src="';echo base_url('assets/img/loader.gif');;echo '"></label>
                                ...
                                <div role="tabpanel" class="tab-pane" id="profile">
                                  <div class="container-wrap">
                                    <div class="row">
                                      <div class="col-lg-1" >
                                        <label for=""> Id</label>
                                        <select class="form-control select2" id="pro_itemid_dropdown">
                                          <option value="" disabled="" selected="">Item Id</option>
                                          ';foreach ($items as $item): ;echo '                                            <option value="';echo $item['item_id'];;echo '" data-uom_item="';echo $item['uom'];;echo '" data-prate="';echo $item['cost_price'];;echo '" data-grweight="';echo $item['grweight'];;echo ' " data-stqty="';echo $item['stqty'];;echo '" data-stweight="';echo $item['stweight'];;echo '" >';echo $item['item_id'];;echo '</option>
                                          ';endforeach ;echo '                                        </select>
                                      </div>
                                      <div class="col-lg-4" >
                                        <label for="" id="stqty_lbl">Procuce Item</label>
                                        <div class="input-group">
                                          <select class="form-control select2" id="pro_item_dropdown">
                                            <option value="" disabled="" selected="">Item description</option>
                                            ';foreach ($items as $item): ;echo '                                              <option value="';echo $item['item_id'];;echo '" data-uom_item="';echo $item['uom'];;echo '" data-prate="';echo $item['cost_price'];;echo '" data-grweight="';echo $item['grweight'];;echo '" data-stqty="';echo $item['stqty'];;echo '" data-stweight="';echo $item['stweight'];;echo '" >';echo $item['item_des'];;echo '</option>
                                            ';endforeach ;echo '                                          </select>
                                          <a class="input-group-addon btn btn-primary active"   tabindex="-1" style="min-width:40px !important;" id="pro_A3" data-target="#ItemAddModel" data-toggle="modal" href="#addItem" rel="tooltip"
                                          data-placement="top" data-original-title="Add Item" data-toggle="tooltip" data-placement="bottom" title="Add New Account Quick (F3)">+</a>
                                        </div>
                                      </div>
                                      <div class="col-lg-2">                                                
                                       <label>Phase</label>
                                       <select class="form-control select2" id="pro_phase_dropdown">
                                        <option value="" selected="" disabled="">Phase</option>
                                        ';foreach ($phase as $phases): ;echo '                                          <option value="';echo $phases['id'];;echo '">';echo $phases['name'];;echo '</option>
                                        ';endforeach ;echo '                                      </select>                                          
                                    </div>
                                    ...
                                    <div class="col-lg-1">
                                      <label for="">Uom</label>                                                    
                                      <input type="text" class="form-control readonly num" id="pro_txtUom" readonly="" tabindex="-1">                                                    
                                    </div>
                                    <div class="col-lg-1">
                                      <label for="">Dzn Qty</label>                                                    
                                      <input type="text" class="form-control num" id="pro_txtDozenQty">                                                    
                                    </div>
                                    <div class="col-lg-1">
                                      <label for="">Bag</label>                                                    
                                      <input type="text" class="form-control num" id="pro_txtBag">                                                    
                                    </div>
                                    <div class="col-lg-1">
                                      <label for="">Qty</label>                                                    
                                      <input type="text" class="form-control num" id="pro_txtQty">                                                    
                                    </div>
                                  </div>
                                  <div class="row">
                                    <div class="col-lg-1">
                                      <label for="">GW</label>                                                    
                                      <input type="text" class="form-control readonly num" id="pro_txtGWeight" readonly="" tabindex="-1">                                                    
                                    </div>

                                    <div class="col-lg-1">
                                      <label for="">Weight</label>                                                    
                                      <input type="text" class="form-control num" id="pro_txtWeight">                                                    
                                    </div>
                                    <div class="col-lg-1 hide">
                                      <label for="">Rate</label>                                                    
                                      <input type="text" class="form-control num" id="pro_txtPRate">                                                    
                                    </div>


                                    <div class="col-lg-1 amnt_width hide" >
                                      <label for="">Amount</label>                                                    
                                      <input type="text" class="form-control readonly num" id="pro_txtAmount" readonly="true" tabindex="-1">                                                    
                                    </div>
                                    <div class="col-lg-1" >
                                      <label for="">Add</label>                                                     
                                      <a href="" class="btn btn-primary" id="pro_btnAdd">+</a>
                                    </div>         
                                  </div>
                                  <div class="row">
                                    <div class="col-lg-12">
                                      ...
                                      <div id="no-more-tables">
                                        <table class="col-lg-12 table-bordered table-striped table-condensed cf" id="pro_purchase_table">
                                          <thead class="cf tbl_thead">
                                            <tr>
                                              <th>Sr#</th>
                                              <th>Id</th>
                                              ...
                                              <th class="numeric hide" style=\'text-align:right;\'>Amount</th>
                                              <th>Action</th>
                                            </tr>
                                          </thead>
                                          <tbody>
                                          ...
                                          <tfoot class="tfoot_tbl">
                                            <tr>
                                              ...
                                              <td data-title="" class="numeric" ></td>
                                              <td data-title="" class="numeric" >Total:</td>  
                                              <td data-title="Dozen" class="numeric" id="pro_txtTotalDozen"></td>
                                              <td data-title="Bag" class="numeric" id="pro_txtTotalBag"></td>
                                              <td data-title="Qty" class="numeric" id="pro_txtTotalQty"></td>
                                              <td data-title="Weight" class="numeric" id="pro_txtTotalWeight"></td>                                   
                                              <td data-title="" class="numeric hide" ></td>
                                              <td data-title="Amount" class="numeric hide" id="pro_txtTotalAmount"></td>
                                              <td data-title="" class="numeric"></td>
                                            </tr>
                                          </tfoot>
