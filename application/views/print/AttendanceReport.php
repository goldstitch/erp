...
echo '<script id="general-head-template" type="text/x-handlebars-template">
    <tr>
        ...
        <th class="no_sort" style="width: 30px;">Vr# </th>
        <th class="no_sort" style="width:20px;">Id </th>
        <th class="no_sort" style="width:150px;">Employee </th>
        <th class="no_sort" style="width:90px;">FName </th>
        <th class="no_sort" style="width:90px;">Designation </th>
        <th class="no_sort" style="width:90px;">Department </th>
        <th class="no_sort"style="width: 90px;" >Shift </th>
        <th class="no_sort"style="width: 40px;" >Status </th>
        <th class="no_sort" style="width: 60px;">TimeIn</th>
        <th class="no_sort" style="width: 60px;">TimeOut</th>
        <th class="no_sort" style="width: 60px;">Late</th>
...
<script id="voucher-sum-template" type="text/x-handlebars-template">
  <tr class="finalsum">
     ...
     <td colspan="12" class="text-right txtbold" style="text-align:right !important; word-spacing: 15px;">{{ VOUCHER_SUM }}</td>
  </tr>
</script>
...
<div id="main_wrapper">
    ...
    <div class="page_bar">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page_title" style="text-transform:capitalize;"> Attendance Report </h1>
            </div>
        </div>
    </div>
                                            ...
                                            <ul class="stats">
                                                ...
                                                <li class=\'red\'>
                                                    <div class="details">
                                                        ...
                                                        <span style="font-weight:bolder !important; font-size: 14px !important;">G Holiday</span>
                                                    </div>
                                                </li>
                                                <li class=\'green\'>
                                                    <div class="details">
                                                ...
                                                <li class=\'brown\'>
                                                    <div class="details">
                                                        <span class="big Late">0</span>
                                                        <span style="font-weight:bolder !important; font-size: 14px !important;">Late</span>
                                                    </div>
                                                </li>
