...
<body>
	...
	<div id="wrap">
		<div class="container-fluid">
			...
			<div id=\'heading\'>
				<span id=\'headingtitle\'>Wages Sheet For The Month Of <span id=\'month\'></span>, <span id=\'year\'></span> </span>
			</div>
	...
	<script>
        ...
        $(\'.otrate\').closest(\'td\').hide();
        $(\'.othour\').closest(\'td\').hide();
		...
		$(\'#salarysheet tbody tr\').each(function(index, elem) {
			...
			if (dept_name != d_name) {
				if(index!=0){
					$(\'<tr style="font-size:10px !important;font-weight:bolder !important; color:red; border-top:1px solid black;"> <td colspan="5" class="text-right">Total:</td><td colspan="1" class="text-right">\'+ gross_bsalary +\'</td><td colspan="1" class="text-right">\'+ gross_salary +\'</td><td colspan="1" class="text-right">\'+ gross_inventive +\'</td><td colspan="1" class="text-right">\'+ gross_gsalary +\'</td><td colspan="1" class="text-right">\'+ gross_advance +\'</td><td colspan="1" class="text-right">\'+ gross_loan +\'</td><td colspan="1" class="text-right">\'+ gross_netsalary +\'</td><td></td></tr>\').insertBefore($(elem).closest(\'tr\'));	
				}
				dept_name = d_name;
			...
			if(index == lng-1 ){
					$(\'<tr style="font-size:10px !important;font-weight:bolder !important; color:red; border:1px solid black; "> <td colspan="5" class="text-right">Grand Total:</td><td colspan="1" class="text-right">\'+ parseFloat(net_bsalary).toFixed(2) +\'</td><td colspan="1" class="text-right">\'+ net_salary +\'</td><td colspan="1" class="text-right">\'+ net_inventive +\'</td><td colspan="1" class="text-right">\'+ net_gsalary +\'</td><td colspan="1" class="text-right">\'+ net_advance +\'</td><td colspan="1" class="text-right">\'+ net_loan +\'</td><td colspan="1" class="text-right">\'+ net_netsalary +\'</td><td></td></tr>\').insertAfter($(elem).closest(\'tr\'));	
					$(\'<tr style="font-size:10px !important;font-weight:bolder !important; color:black; border-top:1px solid black; "> <td colspan="5" class="text-right">Total:</td><td colspan="1" class="text-right">\'+ gross_bsalary +\'</td> <td colspan="1" class="text-right">\'+ gross_salary +\'</td><td colspan="1" class="text-right">\'+ gross_inventive +\'</td><td colspan="1" class="text-right">\'+ gross_gsalary +\'</td><td colspan="1" class="text-right">\'+ gross_advance +\'</td><td colspan="1" class="text-right">\'+ gross_loan +\'</td><td colspan="1" class="text-right">\'+ gross_netsalary +\'</td><td></td></tr>\').insertAfter($(elem).closest(\'tr\'));	
