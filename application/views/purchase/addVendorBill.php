...
echo '<script id="voucher-bill-item-template" type="text/x-handlebars-template">
  <tr>
    <td class="vrnoa" data-vrnoa={{vrnoa}} data-wo={{workorder}}  >{{vrnoa}}</td>
    <td class=\'vrdate\'>{{vrdate}}</td>
    <td class=\'etype\'>{{etype}}</td>

    <td class="item" data-item_id={{item_id}} data-inventory_id={{inventory_id}} data-uom={{uom}} >{{item_des}}</td>
    <td class=\'text-right qty\'>{{qty}}</td>
    <td class=\'text-right weight\'>{{weight}}</td>
...
<div id="party-lookup" class="modal fade modal-lookup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div id="item-lookup" class="modal fade modal-lookup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="page_bar">
      <div class="row">
        <div class="col-md-4">
          <h1 class="page_title">Vendor Bill</h1>
        </div>
        <div class="col-lg-8">
          <a class="btn btn-sm btn-default btnReset"><i class="fa fa-refresh"></i> Reset F5</a>
          <a class="btn btn-sm btn-default btnSave" data-savegodownbtn=\'';echo $vouchers['warehouse']['insert'];;echo '\' data-saveaccountbtn=\'';echo $vouchers['account']['insert'];;echo '\' data-saveitembtn=\'';echo $vouchers['item']['insert'];;echo '\' data-insertbtn=\'';echo $vouchers['vendorbillvoucher']['insert'];;echo '\' data-updatebtn=\'';echo $vouchers['vendorbillvoucher']['update'];;echo '\' data-deletebtn=\'';echo $vouchers['vendorbillvoucher']['delete'];;echo '\' data-printbtn=\'';echo $vouchers['vendorbillvoucher']['print'];;echo '\' ><i class="fa fa-save"></i> Save F10</a>
                      ...
                      <div class="panel-body">
                        ...
                        <form action="">
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-2">
                              <a href=\'\' tabindex="23" class="btn btn-default btnInvoice" ><i class="fa fa-book fa-fw"></i> Pending Bill F7</a>
                            </div>
                          ...
                          <div class="row">
                            ...
                            <div class="row">
                              ...
                              <div class="col-lg-2">                                                
                                <label>PO#</label>
                                <input type="text" class="form-control input-sm " id="txtOrderNo" readonly="">    
                              </div>
                              <div class="col-lg-1">                                                
                                <label>IGP#</label>
                                <input type="text" class="form-control input-sm " id="txtIgp">    
                              </div>                                                                                
                              <div class="col-lg-5">                                            
                                <label>Remarks</label>
                            ...
                            <div class="container-wrap hide">
                              <div class="row">
                                <div class="col-lg-4">
                                  ...
                                  <div class="col-lg-1">
                                    <label for="">Gst%</label>                                                    
                                    <input type="text" class="form-control num" id="txtgstp">                                                    
                                  </div>
                                  <div class="col-lg-1">
                                    <label for="">Gst</label>                                                    
                                    <input type="text" class="form-control num" id="txtgst">                                                    
                                  </div>
                                </div>
                                <div class="row">
                                  ...
                                  <div class="col-lg-1 hide">
                                    <label for="">Fed%</label>                                                    
                                    <input type="text" class="form-control num" id="txtfedp">                                                    
                                  </div>
                                  <div class="col-lg-1 hide">
                                    <label for="">Fed</label>                                                    
                                    <input type="text" class="form-control num" id="txtfed">                                                    
                                  </div>
                                  <div class="col-lg-2">
                                  ...
                                  <div class="col-lg-1">                                                
                                    <label>WO#</label>
                                    <input type="text" class="form-control input-sm  num" id="txtWorkOrder">
                                  </div>

                                  <div class="col-lg-1">                                                
                                    <label>Vr#</label>
                                    <input type="text" class="form-control input-sm  num" id="txtVr">
                                  </div>
                                  <div class="col-lg-1">                                                
                                    <label>Type</label>
                                    ...
                                    <table class="col-lg-12 table-bordered table-striped table-condensed cf" id="purchase_table">
                                      <thead class="cf">
                                        <tr>
                                          ...
                                          <th class="text-right">Gst</th>
                                          <th class="text-right hide">Fed%</th>
                                          <th class="text-right hide">Fed</th>
                                          <th class="text-right">Amount</th>
                                          <th class="numeric text-right">WO#</th>
                                          <th class="numeric text-left">Vr#</th>
                                          <th class="numeric text-left">Type</th>
                                          <th class="numeric text-left">Date</th>
                                      ...
                                      <tfoot class="tfoot_tbl cf">
                                       <tr>
                                         <td class="text-right" colspan="4">Totals</td>
                                         <td  class="text-right txtTotalQty"></td>
                                         <td  class="text-right txtTotalDozen"></td>
                                         <td  class="text-right txtTotalWeight"></td>
                                         <td  class=""></td>
                                         <td  class="text-right txtTotalGstP"></td>
                                         <td  class="text-right txtTotalGst"></td>
                                         <td  class="text-right txtTotalFedP hide"></td>
                                         <td  class="text-right txtTotalFed hide"></td>
