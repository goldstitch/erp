                                            ...
                                            <table class="col-lg-12 table-bordered table-striped table-condensed cf" id="purchase_table">
                                                ...
                                                <tfoot class="tfoot_tbl cf">
                                                    <tr class="">
                                                        ...
                                                        <td  class="text-right numeric txtTotalQty"></td>
                                                        <td  class="text-right numeric txtTotalDozen"></td>
                                                        <td  class="text-right numeric txtTotalWeight"></td>
                                                        <td  class="text-right numeric"></td>
                                                        <td  class="text-right txtTotalGstP"></td>
                                                        <td  class="text-right txtTotalGst"></td>
                                                        <td  class="text-right numeric txtTotalAmount"></td>
                                                        <td> </td>
                                                    </tr>
                                                </tfoot>
