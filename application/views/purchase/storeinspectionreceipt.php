...
<div id="main_wrapper">
    ...
    <div class="page_bar">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page_title">Store Insepction Receipt Voucher</h1>
            </div>
        </div>
    </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <form action="">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-2">
                                                <div class="input-group">
                                                    <span class="input-group-addon id-addon">SIR#</span>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon txt-addon">IGP#</span>
                                                    <input type="text" class="form-control" id="txtIGPNo">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="container-wrap">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-2">
                                                    <div class="input-group">
                                                        <span class="input-group-addon" style=\'min-width: 0px;\'>Qty Rec</span>
                                                        <input type="text" class="form-control num" id="txtQtyRec">
                                                    </div>
                                                </div>
                                                <div class="col-lg-2">
                                                    <div class="input-group">
                                                        <span class="input-group-addon" style=\'min-width: 0px;\'>Qty Rej</span>
                                                        <input type="text" class="form-control num" id="txtQtyRej">
                                                    </div>
                                                </div>
                                                <div class="col-lg-2">
                                                    <div class="input-group">
                                                        <span class="input-group-addon" style=\'min-width: 0px;\'>Qty Final</span>
