        ...
        <div class="container-fluid">
            ...
            <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-2">                                                
                                                            ...
                                                            <select class="form-control input-sm select2" id="broker">
                                                                ...
                                                                ';foreach ($brokers as $broker): ;echo '                                                                    <option value="';echo $broker['id'];;echo '">';echo $broker['name'];;echo '</option>
                                                                ';endforeach ;echo '                                                            </select>                                               
                                                        </div> 
                                                        <div class="col-lg-3">
                                                            <label>Party</label>
                                                        ...
                                                        <div class="col-lg-2">                                                
                                                            ...
                                                            <datalist id=\'approved\'>
                                                                ';foreach ($approvedby as $approv): ;echo '                                                                    <option value="';echo $approv['approvedby'];;echo '">
                                                                ';endforeach ;echo '                                                            </datalist>
                                                            <!-- <select class="form-control select2" id="preparedBy">
             ...
             -->                                        </div>
                                                                                  ...
                                                                                  <div class="row">
                                                                                    ...
                                                                                    <div class="col-lg-1">
                                                                                            ...
                                                                                            <div class="col-lg-1">
                                                                                                ...
                                                                                                <input type="text" class="form-control readonly num" id="txtDozenqty" >                                                    
                                                                                            </div>
                                                                                            <div class="col-lg-1">
                                                                              ...
                                                                              <div class="col-lg-12">
                                                                                <div class="form-group">
                                                                                  <div class="row">
                                                                                    ...
                                                                                    <div class="col-lg-5">
                                                                                      <label for="">Item Description1</label>
                                                                                                <div class="input-group" >
                                                                                                <select class="form-control select2" id="item_dropdown">
                                                                                                    <option value="" disabled="" selected="">Item description</option>
                                                                                                    ';foreach ($items as $item): ;echo '                                                                                                        <option value="';echo $item['item_id'];;echo '" data-uom_item="';echo $item['uom'];;echo '" data-prate="';echo $item['cost_price'];;echo '" data-brand="';echo $item['brand_name'];;echo '">';echo $item['item_des'];;echo '</option>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="panel panel-default">
                                            <div class="panel-body">
                                                <div class="row">
                                                  <div class="col-lg-12">
                                                    <!-- <h5 class="text-muted">Consumed</h5> -->
                                                    <div class="col-lg-1">                                                    
                    ...
                    </di   <div class="tab-pane fade" id="Search">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-3">
