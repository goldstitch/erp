...
<div id="main_wrapper">
	...
	<div class="page_bar">
		<div class="row">
			<div class="col-md-12">
				<h1 class="page_title">Add Fabric</h1>
			</div>
		</div>
	</div>
							...
							<div class="row">
								<div class="col-lg-12">
									<div class="panel panel-default">
										...
										<div class="col-lg-2">
											<label class="">Dye unit</label>
											<select class="form-control select2" id="dye_unit">
											<option value="" disabled="" selected="">Choose Unit</option>
											<option value="METER">METER</option>
											<option value="YARD">YARD</option>
											</select>
										...
										<div class="col-lg-2">
											<label>Dye Rate </label>
											<input type="number" class="form-control input-sm" id="dye_rate" >
									    </div>
													...
													<table class="table table-striped table-hover ar-datatable">
														<thead>
															<tr>
																...
																<th style=\'background: #368EE0;\'>Dye Unit </th>
																<th style=\'background: #368EE0;\'>Dye Rate</th>
