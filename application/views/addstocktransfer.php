                                      ...
                                      <div id="no-more-tables">
                                        <table class="table table-striped table-bordered" id="purchase_table">
                                          ...
                                          <tfoot class="tfoot_tbl">
                                            ...
                                            <td data-title="Dozen" class="numeric" id="txtGDozen" style=\'text-align:right;\'></td>
                                            ...
                                            <td data-title="Weight" class="numeric" id="txtGWeight" style=\'text-align:right;\'></td><!-- <input type="text" class="form-control num" id="txtGWeight" readonly="true" tabindex="-1" style=\'text-align:right;\'></td> -->
                                            <td data-title="" class="numeric"></td>
                                            <td data-title="" class="numeric"></td>
                                          </tfoot>
                                        </table>
