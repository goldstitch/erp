...
<div id="main_wrapper">
	...
	<div class="page_bar">
		<div class="row">
			<div class="col-md-12">
				<h1 class="page_title">Add Embroidry</h1>
			</div>
		</div>
	</div>
								...
								<div class="col-lg-12">
									<div class="panel panel-default">
										<div class="panel-body">
											...
											<div class="col-lg-2">
												<label >Stitch Per lakh cost</label>
												<input type="text" class="form-control input-sm" id="cost">
											</div>
													...
													<table class="table table-striped table-hover ar-datatable">
														<thead>
															<tr>
																...
																<th style=\'background: #368EE0;\'>Stitch Per lakh cost</th>
														...
														<tbody>
															';$counter = 1;foreach ($departments as $department): ;echo '													<tr>
																	...
																	<td>&nbsp&nbsp&nbsp';echo $department['cost'];;echo '</td>
																	<td>&nbsp&nbsp&nbsp';echo $department['unit'];;echo '</td>
																	<td><div class="btn btn-sm btn-primary btn-edit-dept showallupdatebtn" data-transporter_id="';echo $department['id'];;echo '" data-transporter2_id="';echo $department['name'];; echo '"   data-transporter4_id="';echo $department['cost'];;echo '" data-transporter5_id="';echo $department['unit'];;echo '"><span class="fa fa-edit"></span></div></td>
																</tr>
