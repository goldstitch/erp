...
<body>
					...
					<div class="span12 centered">
						<!-- <div class="row-fluid">
							<div class="span12 text-center">
								<h3 class="text-center shadowhead">Expense Sheet</h3>
						...
						<div class="row-fluid">
							<h3 class="text-right">Total:<span class="totalexpense"></span></h3>
						</div>
					</div>
				</div>
				<br>
	...
	<script type="text/javascript">
		$(function(){
			...
			var totalexpense = opener.$(\'#inpTotalExpenses\').val();
			var expenseRows = opener.$(\'#expenseRows tr\').clone();

			$(\'.expenseRows\').html(expenseRows);
			$(\'.toDate\').html(toDate);
