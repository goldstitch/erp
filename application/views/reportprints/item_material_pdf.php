	...
	<head>
		...
		<style>
			 * { margin: 0; padding: 0; font-family: tahoma !important; }
			 body { font-size:10px !important; font-family: tahoma !important; }
			 ...
			 .fieldTotal { font-size:10px !important; font-weight: bold !important; display: inline-block !important; width: 100px !important; } 
			 .fieldHeading { font-size:10px !important; font-weight: bold !important; display: inline-block !important; width: 150px !important; } 
			 ...
			 table { width: 98% !important; border: 0.5px solid black !important; border-collapse:collapse !important; table-layout:fixed !important; margin-left:1px}
					...
					<div class="row-fluid relative">
						<div class="span12">
								<div class="block pull-left inv-leftblock" style="width:250px !important; display:inline !important;">
									...
									<p><span class="field ">Finish Item:</span><span class="fieldvalue cust-name">Article# ';echo $vrdetail[0]['artcile_no_item'] .', '.$vrdetail[0]['finisheditem'];;echo '</span></p>
						...
						<table class="voucher-table">
							...
							<thead>
								<tr>
									...
									<th style=" width: 15px; " class=\'text-right\'>Wastage</th>
									<th style=" width: 15px; " class=\'text-right\'>NetQty</th>
...
$netQty += abs($row['qty']);
$netQtyGross += abs($row['qtyf']);
$netAmount += $row['amount'];
$grandNetAmount += $row['amount'];
...
;echo '									<tr  class="item-row">
									   ...
									   <td class=\'text-right\'>';echo number_format(abs($row['qtyf']),3);;echo '</td>
									   <td class=\'text-right\'>';echo number_format(abs($row['rate2']),3);;echo '</td>
									   <td class=\'text-right\'>';echo number_format(abs($row['qty']),3);;echo '</td>
									   <td class=\'text-right\'>';echo number_format(($row['rate']),3);;echo '</td>
									   <td class="text-right">';echo number_format(($row['amount']),3);;echo '</td>
									</tr>
								';}endforeach;echo '							</tbody>
							<tfoot>
								<tr class="foot-comments">
									<td class="subtotal bold-td text-right" colspan="3">Subtotal:</td>
									<td class="subtotal bold-td text-right">';echo number_format($netQtyGross,3);;echo '</td>
									<td class="subtotal bold-td text-right"></td>
									<td class="subtotal bold-td text-right">';echo number_format($netQty,3);;echo '</td>
									<td class="subtotal bold-td text-right"></td>
									<td class="subtotal bold-td text-right">';echo number_format($netAmount,3);;echo '</td>
								</tr>
							</tfoot>
						</table>
					</div>
					...
					<div class="row-fluid">
						<table class="voucher-table">
							<div class="row-fluid fieldHeading" > Fabric </div>
							<thead>
								<tr>
									<th style=" width: 10px; ">Sr#</th>
									<th style=" width: 100px; text-align:left; ">Description</th>
						...
						<table class="voucher-table">
							...
							<thead>
								<tr>
									...
									<th style=" width: 30px; "class=\'text-right\'>Rate</th>
									<th style=" width: 70px; "class=\'text-right\'>Calculation Method</th>
								</tr>
							</thead>
							<tbody>
								';
...
$grandNetAmount += $row['rate'];
;echo '									<tr  class="item-row">
									   <td class=\'text-left\'>';echo $serial++;;echo '</td>
									   <td class=\'text-left\'>';echo $row['subphase_name'];;echo '</td>
									   <td class=\'text-centre\'>';echo $row['uom'];;echo '</td>
									   <td class=\'text-right\'>';echo number_format(($row['rate']),3);;echo '</td>
									   <td class="text-right">';echo ($row['calculationmethod']);;echo '</td>
									</tr>
								';}endforeach;echo '							</tbody>
					...
					<div class="row-fluid relative">
						<div class="span12">
								<div class="block pull-left inv-leftblock" style="width:250px !important; display:inline !important;">
									<p><span class="fieldTotal">Finished Qty#</span><span class="fieldvalue inv-vrnoa">';echo number_format($vrdetail[0]['fqty'],3);;echo '</span></p>									
									<p><span class="fieldTotal">Finished Weight:</span><span class="fieldvalue inv-date">';echo number_format($vrdetail[0]['fqty'],3);;echo '</span></p>
									<p><span class="fieldTotal ">Cost:</span><span class="fieldvalue cust-name">';echo number_format($vrdetail[0]['namount'],3);;echo '</span></p>
									<p><span class="fieldTotal ">Totam Cost:</span><span class="fieldvalue cust-name">';echo number_format($grandNetAmount,3);;echo '</span></p>
