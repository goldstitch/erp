					...
					<div class="row-fluid">
						<table class="voucher-table">
							<thead>
								...
								<th style=" width: 60px; text-align:left;">Job_Detail</th>
								<th style=" width: 30px; text-align:left;">Item_desc</th>
								...
								<th style=" width: 30px; text-align:left;">Start Date</th>
								<th style=" width: 30px; text-align:left;">End Date</th>
								</tr>
							</thead>
...
;echo '									
									<tr style="border-bottom:0.5px dotted #ccc;" class="item-row">
									   ...
									   <td>';echo $row['job_detail'];;echo '</td>
									   <td>';echo $row['item_desc'];;echo'</td>
									   <td>';echo $row['qty'];;echo'</td>
									   <td>';echo $row['rate'];;echo'</td>
									   <td>';echo $row['amount'];;echo'</td>
									   <td>';echo $row['start_date'];;echo '</td>
									   <td>';echo $row['end_date'];;echo '</td>
									</tr>
