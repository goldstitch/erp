						...
						<table class="voucher-table">
							<thead>
								<tr>
									...
									<th style=" width: 20px; ">Issue No</th>
									<th style=" width: 30px; text-align:right;"> Qty</th>
									<th style=" width: 30px; text-align:right ;">Weight</th>
									<th style=" width: 25px; text-align:left;">From</th>
									<th style=" width: 40px; text-align:left;">Location</th>
								</tr>
							</thead>
...
;echo '									<tr  class="item-row">
									   ...
									   <td class=\'text-centre\'>';echo $row['job_id'];;echo '</td>
									   <td class=\'text-right\'>';echo $row['qty'];;echo '</td>
									   <td class=\'text-right\'>';echo number_format(abs($row['weight']),2);;echo '</td>
									   <td class=\'text-left\'></td>
									   <td class="text-left">';echo (($row['dept_to']));;echo '</td>
									</tr>
						...
						<table class="voucher-table">
							<thead>
								<tr>
									...
									<th style=" width: 100px; text-align:left; ">Description</th>
									<th style=" width: 20px; ">Issue No</th>
									<th style=" width: 30px; text-align:right;">Consume Qty</th>
									<th style=" width: 30px; text-align:right ;">Weight</th>
									<th style=" width: 25px; text-align:left;">From</th>
									<th style=" width: 40px; text-align:left;">Location</th>
								</tr>
						...
						<table class="voucher-table">
							<thead>
								<tr>
									...
									<th style=" width: 100px; text-align:left; ">Description</th>
									<th style=" width: 20px; ">Issue No</th>
									<th style=" width: 30px; text-align:right;">Received Qty</th>
									<th style=" width: 35px; text-align:right ;">Remaining Qty</th>
									<th style=" width: 25px; text-align:left;">From</th>
									<th style=" width: 40px; text-align:left;">Location</th>
								</tr>
							</thead>
