...
echo '<!doctype html>
	...
	<head>
		...
		<style>
			...
			.subtotalend { font-size: 8px !important; font-weight: bold !important;text-align: right !important; }
				...
				<div class="span12 centered">
					...
					<div class="row-fluid relative">
						<div class="span12">
								...
								<div class="block pull-right" style="width:200px !important; float: right; display:inline !important;">
...
;echo '													<td class="bold-td text-left" colspan="5">';echo $row['type'];;echo '</td>
												';
$typee=$row['type'];
$netQty = 0;
$netAmount=0;
