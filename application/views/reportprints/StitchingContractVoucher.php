						...
						<table class="voucher-table">
							<thead>
								<tr style="color:white !important;">
									...
									<th style=" width: 60px; text-align:left; ">Description</th>
									<th style=" width: 30px; text-align:left; ">Phaase From</th>
									<th style=" width: 30px; text-align:left; ">Phase To</th>
									<th style=" width: 10px; ">Uom</th>
									<th style=" width: 15px; " class=\'text-right\'>Qty</th>
									<th style=" width: 18px; " class=\'text-right\'>Weight</th>
									<th style=" width: 18px; " class=\'text-right\'>Req Wt</th>
...
;echo '									<tr  class="item-row">
									   ...
									   <td class=\'text-left\'>';echo $row['phase_name'];;echo '</td>
									   <td class=\'text-left\'>';echo $row['phaseTo'];;echo '</td>
									   <td class=\'text-centre\'>';echo $row['uom'];;echo '</td>
									   <td class=\'text-right\'>';echo number_format(abs($row['qty']/12),0);;echo '</td>
...
endforeach;echo '							</tbody>
							<tfoot>
								<tr class="foot-comments">
									<td class="subtotalend bold-td text-right" colspan="5">Subtotal:</td>
									<td class="subtotalend bold-td text-right">';echo number_format($netQty/12,0);;echo '</td>
