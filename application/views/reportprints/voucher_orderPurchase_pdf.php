...
echo '<!doctype html>
	...
	<head>
		...
		<style>
			...
			.rcpt-header { width: 690px !important; margin: 0px; display: inline;  top: 0px; right: 0px; }
				...
				<div class="span12 centered">
					...
					<div class="row-fluid relative">
						<div class="span12">
								<div class="block pull-left inv-leftblock" style="width:250px !important; display:inline !important;">
									...
									<p><span class="field ">WO#</span><span class="fieldvalue cust-name">';echo $vrdetail[0]['workorderno'];;echo '</span></p>
					...
					<div class="row-fluid">
						<table class="voucher-table">
							<thead>
								<tr>
									<th style=" width: 10px; " class="text-left" >Sr#</th>
									<th style=" width: 50px; text-align:left; ">Description</th>
									<th style=" width: 10px; " class="text-center">Uom</th>
									...
									<!-- <th style=" width: 15px; " class=\'text-right\'>L Vendor</th>
									<th style=" width: 15px; " class=\'text-right\'>L Stock</th> -->
								</tr>
							</thead>
...
;echo '</td>
									...
									<tr  class="item-row">
									   ...
									   <td class=\'text-center\'>';echo $row['uom'];;echo '</td>
									   ...
									   <td class="text-right">';echo $row['lvendor'];;echo '</td> -->
									  
									</tr>
									
								';
$netQty += abs($row['qty']);
$netLprate += $row['lprate'];
...
;echo '</td> -->
								...
								';if(intval($vrdetail[0]['discount'])!=0){;echo '								<tr>
									<td class="subtotal bold-td text-right discount-td " colspan="3">Discount:</td>
								...
								';};echo '								';if(intval($vrdetail[0]['expense'])!=0){;echo '								<tr>
									<td class="subtotal bold-td text-right discount-td " colspan="3">Expense:</td>
								...
								';};echo '								';if(intval($vrdetail[0]['tax'])!=0){;echo '								<tr>
									<td class="subtotal bold-td text-right discount-td " colspan="3">Tax:</td>
								...
								';};echo '								';if(!(intval($vrdetail[0]['tax'])==0 &&intval($vrdetail[0]['discount'])==0 &&intval($vrdetail[0]['expense'])==0 &&intval($vrdetail[0]['paid'])==0) ){;echo '								<tr>
									<td class="subtotal bold-td text-right discount-td " colspan="3">NetAmount:</td>
