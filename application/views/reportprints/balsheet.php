...
<head>
	...
	<style>
		...
		table { width: 100%; border: none; border-collapse:collapse; table-layout:fixed; border-collapse: collapse; }
...
<body>
					...
					<div class="span12 centered">
						<!-- <div class="row-fluid">
							<div class="span12 text-center">
								<h3 class="text-center shadowhead">Balance Sheet</h3>
						...
						<table>
							...
							<tbody>
								<tr>
									<td style="border:none !important;"><h4>Assets</h4></td>
									<td style="border:none !important;"><h4>Liabilities</h4></td>
								</tr>
								<tr>
									<td style="border:none !important;" class="assetsTable"></td>
									<td style="border:none !important;" class="liabilityTable"></td>
								</tr>
							</tbody>
						</table>
					</div>
	...
	<script type="text/javascript">
		$(function(){
			...
			var assTable = opener.$(\'.ASSETSRows\').parent(\'table\').clone();
			var liabTable = opener.$(\'.LIABILITIESRows\').parent(\'table\').clone();

			$(assTable).prop(\'id\', \'\');
			$(assTable).prop(\'class\', \'\');
			$(liabTable).prop(\'id\', \'\');
			$(liabTable).prop(\'class\', \'\');

			$(\'.assetsTable\').html(assTable);
			$(\'.liabilityTable\').html(liabTable);
			$(\'.toDate\').html(toDate);
		});
	</script>
</body>
