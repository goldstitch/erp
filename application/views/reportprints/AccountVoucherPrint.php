...
echo '<!doctype html>
	...
	<head>
		...
		<style>
			...
			.item-row td { font-size: 10px !important; padding: 10px !important; border-top: none !important;}
			...
			.top h1 .print-date{float: right !important;font-size: 10px;font-weight: normal;}
			.clear{clear: both;}
...
<!-- 						<div class="top clear">
							<h1>Hilton Purchase Voucher<span class=\'print-date\'>Printed On : 04-12-2016</span> </h1>
							<h1>Hilton Enterprises </h1>
								...
								<table class="box-tbl">
									<tbody>
										<tr>
											...
											<td class="text-right">';echo ($etype=='sale'?''.$vrdetail[0]['dcno'] .'/'.substr($vrdetail[0]['date'],2,2) .'/'.$vrdetail[0]['pid'] : $vrdetail[0]['dcno']);;echo '</td>
										</tr>
										<tr>
										...
										<tr>
											<td class="text-left">Posting Date</td>
...
;echo '</h3>
					...
					<div class="row-fluid clear">
						...
						<table class="voucher-table">
							<thead>
								<tr >
									<th style=" width: 15px; text-align:left; " >Id</th>
									<th style=" width: 45px; text-align:left; ">Account Title</th>
									<th style=" width: 45px;" class=\'text-left\'>Type</th>

									<th style=" width: 45px;" class=\'text-left\'>Narration</th>
...
;echo '										
									...
									<tr  class="item-row">
									   <td class=\'text-left\'>';echo $row['pid']  ;echo '</td>
									   <td class=\'text-left\'>';echo $row['name'];;echo '</td>
									   <td class=\'text-left\'>';echo $row['level3_name'];;echo '</td>

									   <td class=\'text-left\'>';echo $row['description'];;echo '</td>
									   <td class=\'text-right\'>';echo ($row['debit']!=0)?number_format(abs($row['debit']),0):"-";;echo '</td>
									   <td class=\'text-right\'>';echo ($row['credit']!=0)?number_format(abs($row['credit']),0):"-";;echo '</td>
...
endforeach;echo '							</tbody>
							<tfoot>
								<tr class="foot-comments">
									<td style="text-align:left !important;border:none !important;" class="subtotalend bold-td text-left" colspan="">Inwords</td>
									<td style="text-align:left !important;border:none !important;" class="subtotalend bold-td text-left underline" colspan="2">';echo convert_number($netDebit).' '.'Only';;echo '</td>
									<td style="border-top:1px solid black !important;" class="subtotalend bold-td text-right" colspan="">Total:</td>
									<td style="border-top:1px solid black !important;" class="subtotalend bold-td text-right">';echo number_format($netDebit,0);;echo '</td>
									<td style="border-top:1px solid black !important;" class="subtotalend bold-td text-right">';echo number_format($netCredit,0);;echo '</td>
								</tr>
							</tfoot>
						</table>
					</div>
...
;echo '							</p>
					...
					<div class="row-fluid">
						<p>
							...
							<!-- <span class="footer_company">, Powered By: www.alnaharsolution.com</span> -->
						</p>
					</div>
					';
