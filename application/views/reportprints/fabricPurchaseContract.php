	...
	<head>
		...
		<style>
			 * { margin: 0; padding: 0; font-family: tahoma !important; }
			 ...
			 .header-table thead th {background: black !important;border: none;font-size: 13px !important;  } 
			 .font-normal{font-weight: 100;}
			 table { width: 98% !important; border: 1px solid black !important; border-collapse:collapse !important; table-layout:fixed !important; margin-left:1px}
			 ...
			 .extra-detail span { background: #7F83E9 !important; color: black !important; padding: 5px !important; margin-top: 17px !important; display: block !important; margin: 5px 0px !important; font-size: 10px !important; text-transform: uppercase !important; letter-spacing: 1px !important;}
			 ...
			 thead th { font-size: 14px !important; font-weight: bold !important; padding: 10px !important; border: 0.5px solid !important; }
			...
			.item-row td { font-size: 14px !important; padding: 10px !important; border: 0.5px solid black !important;}
						...
						<div class="span12 header">
							<div class="header-field">
								<div class="block pull-left inv-leftblock" style="width:250px !important; display:inline !important;">
									';if ($etype == 'fabricPurchaseContract') {;echo '										<p><span class="field">Contract#</span><span class="fieldvalue inv-vrnoa">';echo $vrdetail[0]['vrnoa'];;echo '</span></p>
