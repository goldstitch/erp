					...
					<div class="row-fluid relative">
						<div class="span12">
								...
								<div class="block pull-right" style="width:280px !important; float: right; display:inline !important;">
									...
									<div class="span12"><img style="float:right; width:200px !important;" class="rcpt-header logo-img" src="';echo $header_img;;echo '" alt=""></div>
...
;echo '									<tr  class="item-row">
							...
							<tfoot>
								...
								';};echo '								';if(intval($vrdetail[0]['tax'])!=0 &&intval($vrdetail[0]['discount'])!=0 &&intval($vrdetail[0]['expense'])!=0 ){;echo '								<tr>
