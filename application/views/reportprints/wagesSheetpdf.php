	...
	<head>
		...
		<style>
			 * { margin: 0; padding: 0; font-family: tahoma !important; }
			 ...
			 thead th { font-size: 14spx !important; font-weight: bold !important; padding: 10px !important; }
		...
		<div class="container-fluid" style="">
			<div class="row-fluid">
				<div class="span12 centered">
					...
					<div id=\'heading\'>
						<span id=\'headingtitle\'>Wages Sheet For The Month Of <span id=\'month\'>';echo date('M, Y',strtotime($vrdetail[0]['dts'] ));;echo '</span> </span>
					</div>
					<br>
					<br>
					<br>
						...
						<table class="voucher-table">
							<thead>
								<tr>
									...
									<th style=" width: 220px; text-align:left">Employee Name</th>
									<th style=" width: 150px; text-align:left">S/D/W/O</th>
									<th style=" width: 150px; text-align:left">Designation</th>
									<th style=" width: 50px; text-align:right">Presents</th>
									...
									<th style=" width: 200px; text-align:right">Signature</th>
								</tr>
							</thead>
							<tbody>
								';
...
if ($dept_name != $d_name) {
if($index!=0){
;echo '											<tr style="font-size:14px !important;font-weight:bolder !important; color:red; border-top:1px solid black; "> <td colspan="5" class="text-right" style="text-align:right !important;">Total:</td><td class="text-right"></td><td class="text-right">';echo ($gross_salary != '0')?$gross_salary : '-';;echo '</td><td class="text-right">';echo ($gross_inventive != '0')?$gross_inventive : '-';;echo '</td><td class="text-right">';echo ($gross_gsalary != '0')?$gross_gsalary : '-';;echo '</td><td class="text-right">';echo ($gross_advance != '0')?$gross_advance : '-';;echo '</td><td class="text-right">';echo ($gross_loan != '0')?$gross_loan : '-';echo '</td><td class="text-right">';echo ($gross_netsalary != '0')?$gross_netsalary : '-';;echo '</td><td></td></tr>	
										';}
$dept_name = $d_name;
;echo '	
											<tr style="font-size:116px !important;font-weight:bolder !important; color:green; border-bottom:1px solid black;"><td colspan="13" class="dept_name_head">';echo $dept_name ;echo '</td></tr>
...
;echo '									<tr  class="item-row">
									   ...
									   <td class="text-right">';echo ($row['paid_days']!= '0.00')?number_format(($row['paid_days']),0) : '-';;echo '</td>
								...
								';endforeach;echo '
								<!-- <tr style="font-size:12px !important;font-weight:bolder !important; color:red; border-top:1px solid black;"> <td colspan="5" class="text-right" style="text-align:right !important;">Total:</td><td class="text-right">';echo ($gross_bsalary != '0')?$gross_bsalary : '-';;echo '</td><td class="text-right"></td><td class="text-right">';echo ($gross_salary != '0')?$gross_salary : '-';;echo '</td><td class="text-right">';echo ($gross_othours != '0')?$gross_othours : '-';;echo ' </td><td colspan="2" class="text-right">';echo ($gross_otamount != '0')?$gross_otamount : '-';;echo '</td><td class="text-right">';echo ($gross_inventive != '0')?$gross_inventive : '-';;echo '</td><td class="text-right">';echo ($gross_gsalary != '0')?$gross_gsalary : '-';;echo '</td><td class="text-right">';echo ($gross_advance != '0')?$gross_advance : '-';;echo '</td><td class="text-right">';echo ($gross_loan != '0')?$gross_loan : '-';echo '</td><td class="text-right">';echo ($gross_netsalary != '0')?$gross_netsalary : '-';;echo '</td><td></td></tr> -->
								<tr style="font-size:14px !important;font-weight:bolder !important; color:red; border-top:1px solid black; "> <td colspan="5" class="text-right" style="text-align:right !important;">Total:</td><td class="text-right"></td><td class="text-right">';echo ($gross_salary != '0')?$gross_salary : '-';;echo '</td><td class="text-right">';echo ($gross_inventive != '0')?$gross_inventive : '-';;echo '</td><td class="text-right">';echo ($gross_gsalary != '0')?$gross_gsalary : '-';;echo '</td><td class="text-right">';echo ($gross_advance != '0')?$gross_advance : '-';;echo '</td><td class="text-right">';echo ($gross_loan != '0')?$gross_loan : '-';echo '</td><td class="text-right">';echo ($gross_netsalary != '0')?$gross_netsalary : '-';;echo '</td><td></td></tr>	

								

							
							
								<tr style="font-size:10px !important;font-weight:bolder !important; color:black; border-top:1px solid black;">
								<td class="text-right"></td>
								<td class="text-right"></td>
								<td class="text-right"></td>
								<td class="text-right"></td>
