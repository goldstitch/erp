					...
					<div class="row-fluid relative">
						<div class="span12">
								<div class="block pull-left inv-leftblock" style="width:250px !important; display:inline !important;">
									...
									<p><span class="field">Order#</span><span class="fieldvalue inv-vrnoa">';echo $vrdetail[0]['ordno'];;echo '</span></p>
						...
						<table class="voucher-table">
							<thead>
								<tr>
									...
									<th style=" width: 20px; " class=\'text-right\'>Type</th>
...
;echo '									<tr  class="item-row">
									   ...
									   <td class=\'text-right\'>';echo $row['type'];;echo '</td>
