                ...
                <table>
                    <tr>
                        ...
                        <td style="height:245px; text-align:center; border-width: 0 1px 0px 0px;">
                            <h3 style="margin:5px 0 3px 0 !important;"></h3>
                            ...
                            <p style="margin:10px 0 0 0 !important; font-size:13px;"></p></td>
                    </tr>
                </table>
            </div>
        </div>
            ...
            <div class="col-xs-6 section-3-left">
                <table>
                    <tr class="section-3-left-1">
                        <td style="height:80px !important; border-top-width:0px;padding-bottom:10px;">
                            <h5 style="margin:5px 0 0 5px !important; font-size:12px; font-weight:bold;"></h5>
