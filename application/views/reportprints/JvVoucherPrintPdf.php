	...
	<head>
		...
		<style>
			 * { margin: 0; padding: 0; font-family: tahoma; }
			 ...
			 table { width: 99%; border: 0.5px solid black; border-collapse:collapse; table-layout:fixed;margin-top: 8%;}
			 th { border: 0.5px solid black; padding: 5px; font-weight: bold !important; }
			 td { /*text-align: center;*/ vertical-align: top; /*padding: 5px 10px;*/ border-left: 0.5px solid black; word-wrap: break-word;}
			...
			.barcode { float: right; }
			.item-row td { font-size: 10px; padding: 4px; border: 1px solid !important;}
					...
					<div class="row-fluid relative">
						<div class="span12">
								<div class="block pull-left inv-leftblock" style="width:250px !important; display:inline !important;">
									<p><span class="field">Jv#</span><span class="fieldvalue inv-vrnoa">';echo $pledger[0]['dcno'];;echo '</span></p>									
...
;echo '									
									<tr style="amountborder-bottom:1px dotted #ccc;" class="item-row">
									   ...
									   <td class=\'text-center\' >';echo $row['pid'];;echo ' </td>
									   <td class=\'text-left\' >';echo $row['party_name'];;echo ' </td>
									   <td  class=\'text-right\'>';echo $row['description'];;echo '</td>
...
;echo '							
								...
								<tr style="amountborder-bottom:1px dotted #ccc; border-top:0.5px solid black !important;" class="item-row">
									<td class="bold-td"></td>
					...
					<div class="row-fluid">
						<div class="span12">
							<table class="signature-fields">
								<thead>
									<tr>
										<th style="border-top: 1px solid !important;">Prepared By</th>
										<th>Checked By</th>
										<th>GM Finance</th>
										<th>Director</th>
