		...
		<div class="container-fluid" style="">
			...
			<div class="row-fluid">
				<div class="span12 centered">
					...
					<br>
					<div class="row-fluid">
						<p><span class="" style="font-size: 16px !important; font-weight:bolder !important; color:red !important;">Received Items</span></p>									
					</div>
					<div class="row-fluid">
...
;echo '									<tr  class="item-row">
									   ...
									   <td class=\'text-right\'>';echo ($row['qty']!=0?number_format($row['uom']=='dozen'?abs($row['qty']/12):abs($row['qty']),0):'-');;echo '</td>
									   ...
									   <td class="text-right">';echo number_format(abs($row['s_amount']),0);;echo '</td>
									</tr>
					...
					<br>
					<div class="row-fluid">
						<p><span class="" style="font-size: 16px !important; font-weight:bolder !important; color:red !important;">Consumed Items</span></p>									
					</div>
						...
						<table class="voucher-table">
							<thead>
								<tr>
									<th style=" width: 10px; ">Sr#</th>
									<th style=" width: 100px; text-align:left;">Description</th>
									<th style=" width: 30px; text-align:left;">Uom</th>
									<th style=" width: 50px; text-align:left;">Phase</th>
									<th style=" width: 20px; text-align:right;">Qty</th>
									<th style=" width: 40px; text-align:right;">Weight</th>
