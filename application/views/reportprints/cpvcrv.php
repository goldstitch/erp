	...
	<style>
		...
		* { margin: 0; padding: 0; font-family: tahoma; }
		...
		@media print {
		 ...
		 @page{margin:5px auto !important; }
		...
		.finalsum td {border-top: 1px solid black; border-left:0 !important; border-right: 0 !important; border-bottom: 1px solid black; background: rgb(250, 250, 250); color: black; }
		 ...
		 td {font-size: 10px; font-family: tahoma; line-height: 14px; padding: 4px;  text-transform: uppercase; border-top: 1px solid;border-left: 1px solid !important;border-right:  1px solid; border-bottom: 1px solid;} 
