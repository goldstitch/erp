...
<head>
	...
	<style>
		...
		@media print {
			thead.htmlRows1{display: table-header-group !important; border-top: 2px solid black !important;}
			thead:nth-child(2){border-top: 1px solid black !important;}
		 	.noprint, .noprint * { display: none; }
		 }
		  thead:nth-child(2){border-top: 1px solid black !important;}
		 .tfoot_tbl{color: red;background-color: white;font-weight: bold; text-align: right;}
		 .centered { margin: auto; }
		 /*@page{margin:10px auto !important;  @bottom-right {
...
*/
		...
		.finalsum td {border-top: 1px solid black; border-left:0 !important; border-right: 0 !important; border-bottom: 1px solid black; background: rgb(250, 250, 250); color: black; }
		 ...
		 td {font-size: 13px; font-family: tahoma; line-height: 14px; padding: 4px;  text-transform: uppercase;} 
