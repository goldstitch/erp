...
<head>
	...
	.field { font-size:16px !important; font-weight: bold !important; display: inline-block !important; width: 100px !important; } 
	.field1 { font-size:16px !important; font-weight: bold !important; display: inline-block !important; width: 150px !important; } 
	.field2 { font-size:14px !important; font-weight: bold !important; display: inline-block !important; width: 0px !important; } 
	.voucher-table{ border-collapse: none !important; }
	.header-table{ border-collapse: none !important;}
	.header-table thead th {background: white !important;border: none;font-size: 15px !important;  } 
	...
	td:first-child {  }
	.voucher-table thead th {background: grey !important; font-size: 16px !important;} 
	...
	.inwords, .remBalInWords { text-transform: uppercase !important; font-size: 16px !important;}
	.barcode { margin: auto !important; }
	h3.invoice-type {font-size: 20px !important; line-height: 24px !important;}
	...
	.nettotal { color: red !important; font-size: 16px !important;}
	...
	thead th { font-size: 12px !important; font-weight: bold !important; padding: 10px !important; border: 0.5px solid !important; }
	.fieldvalue { font-size:16px !important; position: absolute !important; width: 497px !important; }
	...
	.item-row td { font-size: 16px !important; padding: 10px !important; border: 0.5px solid black !important;}
	.footer_company td { font-size: 8px !important; padding: 10px !important; border-top: 0px solid black !important;}
	.signature-fields{ font-size: 204px !important; border: none !important; border-spacing: 20px !important; border-collapse: separate !important;} 
	.signature-fields th { font-size: 18px !important; border: 0px !important; border-top: 1px solid black !important; border-spacing: 10px !important; }
	...
	.nettotal, .subtotal, .vrqty,.vrweight { font-size: 16px !important; font-weight: bold !important;text-align: right !important; color: red;}
	...
	.header{width: 100%;}
	.header-field{width: 70%;float: left !important;}
	.header-terms{width: 30%;float: left !important;}
	.clear{clear: both;}
		...
		<div class="row-fluid">
			<div class="span12 centered">
				<div class="" style="width:280px !important; float: center; display:inline !important;">
					<h3 class="invoice-type text-center" style="border:none !important; margin: 0px !important; position: relative; top: 5px !important; font-size:35px !important; ">';echo $title;;echo '</h3>
				</div>
					...
					<div class="span12 header">
						<div class="header-field">
							...
							<div class="header-terms">
								<p><span class="field">Payment Terms:</span><span class="fieldvalue cust-mobile padd-left">';echo ($vrdetail[0]['payment_term']!==''?$vrdetail[0]['payment_term']:'-');;echo '</span></p>
								<p><span class="field">Delivery Terms:</span><span class="fieldvalue cust-mobile padd-left">';echo ($vrdetail[0]['delivery_term']!==''?$vrdetail[0]['delivery_term']:'-');;echo '</span></p>
							</div>
				...
				<table class="voucher-table">
					<thead>
						<tr >
							...
							<th style=" width: 15px; ">Uom</th>
							<th style=" width: 15px; " class=\'text-right\'>Qty</th>
							<th style=" width: 15px; " class=\'text-right\'>Last</th>
							...
							<th style=" width: 25px; " class=\'text-right\'>Gst</th>
...
;echo '							<tr  class="item-row">
								...
								<td class=\'text-right\'>';echo number_format(($row['item_last_prate']),2);;echo '</td>
								<td class=\'text-right\'>';echo number_format(abs($row['weight']),2);;echo '</td>
								<td class=\'text-right\'>';echo number_format(($row['rate']),2);;echo '</td>
								<td class=\'text-right\'>';echo number_format(($row['gstp']),0);;echo '</td>
								<td class=\'text-right\'>';echo number_format(($row['gst']),0);;echo '</td>


								

								<td class="text-right">';echo number_format(($row['amount']),0);;echo '</td>
							</tr>
							';
$netDozen += ($row['uom']=='dozen'?abs($row['qty']/12):0);
$netQty += abs($row['qty']);
...
endforeach;echo '					</tbody>
					<tfoot>
						<tr class="foot-comments">
							...
							<td class="subtotalend bold-td text-right">';echo number_format($netGst,0);;echo '</td>
							<td class="subtotalend bold-td text-right" colspan="1">';echo number_format($netAmount,2);;echo '</td>
						</tr>
						...
						';};echo '						';if(intval($vrdetail[0]['tax'])!=0){;echo '							<tr>
								<td class="subtotal bold-td text-right" colspan="7">Tax:</td>
			...
			<div class="row-fluid">
				<div class="span12 add-on-detail1" style="margin-top: 10px;">
					<p class="" style="text-transform1: uppercase;">
						<strong class="inwords">In words: </strong> <span class="inwords">';echo strtoupper($amtInWords);;echo ' &nbsp; ONLY </span><br>
						<br>
			...
			<div class="span12">
				<strong class="inwords">Dispatch Address: </strong> <span class="inwords">';echo $vrdetail[0]['dispatch_address'];;echo ' </span><br>
			</div>
			<br>
			<br>
			<div class="row-fluid">
				<p><span class="field2"></span><span class="fieldvalue inv-vrnoa">Special Instructions:</span></p>
				<p><span class="field2"></span><span class="fieldvalue inv-vrnoa">(a) Mention Out Purchase Order No on your invoice / bill.</span></p>
				<p><span class="field2"></span><span class="fieldvalue inv-vrnoa">(b) Supply all of the parts of this order will bind you to accept</span></p>
				<p><span class="field2"></span><span class="fieldvalue inv-vrnoa">then conditions printed on the revers of this form.</span></p>
			</div>
