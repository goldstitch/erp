						...
						<table class="voucher-table">
							<thead>
								<tr>
									...
									<th style=" width: 18px; ">Job.No</th>
									<th style=" width: 20px; text-align:left;">Qty</th>
									<th style=" width: 20px; text-align:left;">Received From</th>
									<th style=" width: 40px; text-align:left;">From</th>
									<th style=" width: 20px; text-align:left;">Received By</th>
...
;echo '									<tr  class="item-row">
									   ...
									   <td class=\'text-left\'>';echo $row['job_id'];;echo '</td>
									   <td class=\'text-left\'>';echo $row['qty'];;echo '</td>
									   <td class=\'text-left\'>';echo (($row['issue']));;echo '</td>
									   <td class=\'text-left\'>';echo (($row['dept_from']));;echo '</td>
									   <td class=\'text-left\'>';echo (($row['receive']));;echo '</td>
							...
							<tfoot>
								<tr class="foot-comments">
									...
									<td class="subtotal bold-td text-left">';echo number_format($netQty,0);;echo '</td>
