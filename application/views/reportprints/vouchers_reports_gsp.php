...
<div class="container my-container">
            ...
            <div class="col-xs-6 section-1-right">
                <table>
                    <tr>
                        ...
                        <td style="height:135px !important;margin-top:280px;">
                            <P style="margin:5px 0 0 10px;"></P><br><br><br><br>
                        </td>
                    </tr>
                </table>
            </div>
    ...
    <table id="tbDetail" class="new">
        ...
        <tr>
            <th class=\'centr\'></th>
            <th class=\'centr\'></th>
            <th style="width:462px;" class=\'centr\'></th>
            <th class=\'centr\'></th>
            <th class=\'centr\'></th>
            <th class=\'centr\'></th>
        </tr>
...
<script type="text/javascript">
    $(function () {
        ...
        var html = "<tr class=\'ming\'>";
        html += "<td style=\'width:100px;\'>FFSFSFS</td>";
        html += "<td style=\'padding-left:10px;\'>PO: " + po + "<br>QTY: " + opener.$(\'td.txtTotalQty\').text() + " DZ.PRS/CTN<br>" + opener.$(\'#txtExportMadeIn\').val() + "<br>CONTAINER NO: <br>" + opener.$(\'#txtContainer\').val() + "</td>";
        html += "<td style=\'width:400px;padding-left:20px;\'>" + opener.$(\'td.txtTotalCtn\').text() + " CTN CONTAINS <br>" + descriptionOfGoods + "</td>";
        html += "<td style=\'width:100px;\'>" + opener.$(\'td.txtQriginCriterion\').text() + "</td>";
        html += "<td style=\'width:100px;padding-left:20px;\'>GR W.T<br>" + opener.$(\'#txtGrossWeight\').val() + "<br>N.WT<br>" + opener.$(\'#txtNetWeight\').val() + "</td>";
        html += "<td style=\'width:100px;padding-left:20px;\'>" + opener.$(\'#txtInvNo\').val() + "<br>" + opener.$(\'#due_date\').val() + "</td>";
        html += "</tr>";
