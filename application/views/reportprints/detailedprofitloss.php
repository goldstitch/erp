                ...
                <div class="box box-color box-bordered">
                    ...
                    <div class="row dates-row" style="background: #F5DFDF; padding: 20px 0px 10px; text-align: center; margin-bottom: 15px; ">
                        ...
                        <div class="row ra-inputs">
                            <div class="col-lg-4">
                                <div class="input-group">
                                    <span class="input-group-addon">Opening Stock</span>
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon">-Purchase Return</span>
                                    <input class="form-control" type="text" name="purchase_return" id="inpPurchaseReturn" >
                                </div>
                                <div class="input-group">
                                    <span class="input-group-addon">=Net Purchase</span>
                                    <input class="form-control" type="text" name="net_purchase" id="inpNetPurchase" >
                                </div>
                                <div class="input-group">
                                    <span class="input-group-addon">Gross Profit/Loss</span>
                        ...
                        <div class="row ra-inputs">
                            ...
                            <div class="col-lg-4">
                                <div class="input-group">
                                    <span class="add-on highlight span5">Net Profit/Loss</span>
