						...
						<table class="voucher-table">
							<thead>
								<tr style="color:white !important;">
									...
									<th style=" width: 30px; " class=\'text-right\'>Bag Rate</th>
									<th style=" width: 30px; " class=\'text-right\'>Bag Wt</th>
									<th style=" width: 30px; " class=\'text-right\'>Req Bag</th>
								</tr>
							</thead>
...
;echo '									<tr  class="item-row">
									   ...
									   <td class=\'text-right\'>';echo number_format(abs($row['qty']/12),2);;echo '</td>
									   ...
									   <td class=\'text-right\'>';echo number_format(abs($row['lprate']),2);;echo '</td>
									   <td class=\'text-right\'>';echo number_format(abs($row['bundle']),2);;echo '</td>
									   <td class=\'text-right\'>';echo number_format(abs($row['bag']),2);;echo '</td>
									</tr>
								';
$netQty += abs($row['qty']);
$netBag += abs($row['bag']);
...
endforeach;echo '							</tbody>
							<tfoot>
								<tr class="foot-comments">
									...
									<td class="subtotalend bold-td text-right">';echo number_format($netQty/12,2);;echo '</td>
									...
									<td class="subtotalend bold-td text-right"></td>
									<td class="subtotalend bold-td text-right"></td>
									<td class="subtotalend bold-td text-right">';echo number_format($netBag,2);;echo '</td>
								</tr>
