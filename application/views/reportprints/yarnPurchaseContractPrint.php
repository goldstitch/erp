						...
						<table class="voucher-table">
							<thead>
								<tr >
									...
									<th style=" width: 15px;" class=\'text-centre\'>Color</th>
									<th style=" width: 15px;" class=\'text-centre\'>Brand</th>
...
if($serial!=1){;echo '											<tr class="foot-comments">
												<td class="subtotalend bold-td text-right" colspan="7">Subtotal:</td>
...
;echo '									<tr  class="item-row">
									   ...
									   <td class=\'text-centre\'>';echo $row['colors'];;echo '</td>
									   <td class=\'text-centre\'>';echo $row['brand'];;echo '</td>
									   <td class=\'text-centre\'>';echo $row['count'];;echo '</td>
									   <td class=\'text-centre\'>';echo $row['qlty'];;echo '</td>
