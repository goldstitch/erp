						...
						<table class="voucher-table">
							<thead>
								<tr>
									...
									<th style=" width: 18px; " class=\'text-right\'>Stock</th>
								</tr>
							</thead>
...
;echo '									<tr  class="item-row">
									   ...
									   <td class=\'text-centre\'>';echo $row['color_name'];;echo '</td>
									   ...
									   <td class=\'text-right\'>';echo number_format(abs($row['lstock']),2);;echo '</td>
									</tr>
...
endforeach;echo '							</tbody>
							<tfoot>
								<tr class="foot-comments">
									...
									<td class="subtotalend bold-td text-right">';echo number_format($netRate,2);;echo '</td>
