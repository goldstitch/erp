					...
					<div class="row-fluid relative">
						<div class="span12">
								<div class="block pull-left inv-leftblock" style="width:250px !important; display:inline !important;">
									...
									<p><span class="field ">M/S:</span><span class="fieldvalue cust-name">';echo $vrdetail[0]['party_name'];;echo '</span></p>
						...
						<table class="voucher-table">
							<thead>
								<tr>
									...
									<th style=" width: 10px;" class=\'text-centre\'>Uom</th>
									<th style=" width: 15px;" class=\'text-centre\'>Count</th>
									<th style=" width: 15px;" class=\'text-centre\'>Pick</th>
									<th style=" width: 15px;" class=\'text-centre\'>Width</th>
									<!-- <th style=" width: 15px;" class=\'text-centre\'>Quality</th> -->
...
if($serial!=1){;echo '											<tr class="foot-comments">
												<td class="subtotalend bold-td text-right" colspan="6">Subtotal:</td>
...
;echo '													<td class="bold-td text-left" colspan="10">';echo $row['type'];;echo '</td>
												';
$typee=$row['type'];
$netQty = 0;
$netAmount=0;
...
;echo '									<tr  class="item-row">
									   ...
									   <td class=\'text-centre\'>';echo $row['count'];;echo '</td>
									   <td class=\'text-centre\'>';echo $row['pick'];;echo '</td>
									   <td class=\'text-centre\'>';echo $row['width'];;echo '</td>
...
endforeach;echo '							</tbody>
							<tfoot>
								...
								';if(intval($vrdetail[0]['discount'])!=0){;echo '								<tr>
									<td class="subtotal bold-td text-right discount-td " colspan="8">Discount:</td>
								...
								';};echo '								';if(intval($vrdetail[0]['expense'])!=0){;echo '								<tr>
									<td class="subtotal bold-td text-right discount-td " colspan="8">Expense:</td>
								...
								';};echo '								';if(intval($vrdetail[0]['tax'])!=0){;echo '								<tr>
									<td class="subtotal bold-td text-right discount-td " colspan="8">Tax:</td>
								...
								';};echo '								';if(!(intval($vrdetail[0]['tax'])==0 &&intval($vrdetail[0]['discount'])==0 &&intval($vrdetail[0]['expense'])==0 &&intval($vrdetail[0]['paid'])==0) ){;echo '								<tr>
									<td class="subtotal bold-td text-right discount-td " colspan="8">NetAmount:</td>
					...
					<!-- <div class="row-fluid">
						<div class="span12">
							<table class="signature-fields11" styl>
									<tr>
										<th></th>
										<td></td>
										<th>Received By</th>
