...
<div id="main_wrapper">
	<div class="page_bar">
		<div class="row">
			<div class="col-md-12">
				<h1 class="page_title">Update Login Code</h1>
			</div>
		</div>
	</div>
							...
							<div class="panel panel-default">
								<div class="panel-body">
									...
									<div class="row">
										<div class="col-lg-4">
											<div class="input-group">
												<span class="input-group-addon" style="font-size: 30px;font-weight: bold;height: 50px;min-width: 150px;">Code</span>
												<input type="text" class="form-control num" id="txtLoginCode" maxlength="4" style="font-size: 40px;font-weight: bold;height: 50px;">
											</div>
										</div>
									</div>
									<div class="row hidden">
									...
									<div class="row hidden">
										<div class="col-lg-7 ">
											<div class="input-group">
												...
												<select  class="form-control input-sm select2" multiple="true" id="dept_dropdown" data-placeholder="Choose Item....">
									...
									<div class="row hidden">
										...
										<div class="col-lg-2">
											<div class="form-group">                                                                
												<div class="input-group">
												<span class="switch-addon">Access Rate?</span>
													<input type="checkbox" checked="" class="bs_switch" id="switchRate">
												</div>
											</div>
										</div>
									</div>
