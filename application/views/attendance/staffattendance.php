		...
		<div class="row">
			...
			<div class="col-lg-9">
				<div class="pull-right">
					...
					<a href=\'\' class="btn btn-default btnSave" data-insertbtn=\'';echo $vouchers['staff_attendance']['insert'];;echo '\'><i class="fa fa-save"></i> Save F10</a>
					<a class="btn btn-default btnPrint" data-printtbtn=\'';echo $vouchers['staff_attendance']['print'];;echo '\'><i class="fa fa-print"></i> Print F9</a>
					
					<a href="" class="btn btn-default btnDelete" data-deletetbtn=\'';echo $vouchers['staff_attendance']['delete'];;echo '\'><i class="fa fa-trash-o"></i> Delete F12</a>
				</div>
			</div>
		</div>
	</div>
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<datalist id=\'status\'>						
								...
								<option value="Gusted Holiday"></option>
