var Account = function() {
	...
	var getMaxIddye = function() {

		$.ajax({

			url : base_url + 'index.php/account/getMaxIddye',
			type : 'POST',
			dataType : 'JSON',
	...
	var save = function () {
		$.ajax({
			url : base_url + 'index.php/account/save_dyeing',
			type : 'POST',
			data : { 'id':$('#txtAccountIdHidden').val(),'name' :$('#txtName').val() ,'code':$('#code').val(),'rate':$('#rate').val(),'unit':$('#unit').val() },
			dataType : 'JSON',
			success : function(data) {
	...
	var update = function () {
		$.ajax({
			url : base_url + 'index.php/account/update_dyeing',
			type : 'POST',
			data : { 'id':$('#txtAccountIdHidden').val(),'name' :$('#txtName').val() ,'code':$('#code').val(),'rate':$('#rate').val() ,'unit':$('#unit').val() },
			dataType : 'JSON',
			success : function(data) {
	...
	var fetch = function(id) {
		...
		$.ajax({
			url : base_url + 'index.php/account/fetch_dye',
			type : 'POST',
			data : { 'id' : id },
			dataType : 'JSON',
			success : function(data) {
	...
	var deleteVoucher = function() {
		...
		$.ajax({
			url : base_url + 'index.php/account/deletedye',
			type : 'POST',
	...
	return {
		...
		bindUI : function() {
			...
			$('.btn-edit-dept').on('click', function() {
				...
				var rate=$(this).data('transporter3_id');
