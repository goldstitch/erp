var Cutting = function() {
	...
	var getMaxIdcut = function() {
		...
		$.ajax({
			...
			url : base_url + 'index.php/account/getMaxIdaccessories',
			type : 'POST',
			dataType : 'JSON',
	...
	var update = function () {
		$.ajax({
			url : base_url + 'index.php/account/update_accessories',
			type : 'POST',
	...
	var fetch = function(id) {
		...
		$.ajax({
			url : base_url + 'index.php/account/fetch_accessories',
			type : 'POST',
			data : { 'id' :id },
			dataType : 'JSON',
			success : function(data) {
	...
	var deleteVoucher = function() {
		...
		$.ajax({
			url : base_url + 'index.php/account/delete_accessories',
			type : 'POST',
	...
	return {
		...
		bindUI : function() {
			...
			$('#qty').on('input', function() {
				...
				var rate=$('#rate').val();
				var qty =$('#qty').val()
				$("#perunitrate").val(parseFloat(rate).toFixed(2)/parseFloat(qty).toFixed(2));
			});
