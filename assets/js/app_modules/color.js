var Cutting = function() {
	...
	var getMaxIdcut = function() {
		...
		$.ajax({
			...
			url : base_url + 'index.php/account/getMaxId_color',
			type : 'POST',
			dataType : 'JSON',
	...
	var save = function () {
		$.ajax({
			url : base_url + 'index.php/account/save_color',
			type : 'POST',
	...
	var update = function () {
		$.ajax({
			url : base_url + 'index.php/account/update_color',
			type : 'POST',
			data : { 'id':$('#txtAccountIdHidden').val(),'name' :$('#txtName').val() },
			dataType : 'JSON',
			success : function(data) {
	...
	var fetch = function(id) {
		...
		$.ajax({
			url : base_url + 'index.php/account/fetch_color',
			type : 'POST',
			data : { 'id' :id },
			dataType : 'JSON',
			success : function(data) {
	...
	var deleteVoucher = function() {
		...
		$.ajax({
			url : base_url + 'index.php/account/delete_color',
			type : 'POST',
