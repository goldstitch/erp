var Purchase = function() {
	...
	var fetchAccount = function() {
		...
		$.ajax({
			...
			type : 'POST',
			data : { 'active' : 1,'typee':'yarnPurchase'},
			dataType : 'JSON',
			success : function(data) {
				if (data === 'false') {
					alert('No data found');
...
var validateSaveItem = function() {
	...
	var save = function(purchase) {
		...
		$.ajax({
			...
			type : 'POST',
			data : { 'voucher_type_hidden':$('#voucher_type_hidden').val(),  'stockmain' : purchase.stockmain, 'stockdetail' : purchase.stockdetail, 'vrnoa' : purchase.vrnoa, 'ledger' : JSON.stringify(purchase.ledger),'etype':'yarnPurchase'  },
			dataType : 'JSON',
			success : function(data) {
	...
	var fetch = function(vrnoa) {
		...
		$.ajax({
			...
			type : 'POST',
			data : { 'vrnoa' : vrnoa , 'company_id': $('#cid').val() ,'etype':'yarnPurchase'},
			dataType : 'JSON',
			success : function(data) {
	...
	var fetchLfiveStocks = function(item_id) {
		$.ajax({
			...
			type : 'POST',
			data : { 'item_id' : item_id , 'company_id': $('#cid').val(),'etype': 'yarnPurchase' ,'vrdate':$('#current_date').val()},
			dataType : 'JSON',
			success : function(data) {
	...
	var deleteVoucher = function(vrnoa) {
		...
		$.ajax({
			...
			type : 'POST',
			data : { 'vrnoa' : vrnoa , 'etype':'yarnPurchase','company_id':$('#cid').val() },
			dataType : 'JSON',
			success : function(data) {
