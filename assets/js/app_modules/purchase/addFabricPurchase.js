var Purchase = function() {
	...
	var fetchAccount = function() {
		...
		$.ajax({
			...
			type : 'POST',
			data : { 'active' : 1,'typee':'fabricPurchase'},
			dataType : 'JSON',
			success : function(data) {
				if (data === 'false') {
					alert('No data found');
...
var validateSaveItem = function() {
	...
	var save = function(purchase) {
		...
		$.ajax({
			...
			type : 'POST',
			data : { 'voucher_type_hidden':$('#voucher_type_hidden').val(),  'stockmain' : purchase.stockmain, 'stockdetail' : purchase.stockdetail, 'vrnoa' : purchase.vrnoa, 'ledger' : JSON.stringify(purchase.ledger),'etype':'fabricPurchase'  },
			dataType : 'JSON',
			success : function(data) {
	...
	var fetch = function(vrnoa) {
		...
		$.ajax({
			...
			type : 'POST',
			data : { 'vrnoa' : vrnoa , 'company_id': $('#cid').val() ,'etype':'fabricPurchase'},
			dataType : 'JSON',
			success : function(data) {
	...
	var appendToTable = function(srno, item_desc, item_id, qty, rate, amount, weight,gstp,gst,fedp,fed,dozen,uom,inventory_id,workorderno) {
		...
		"<td class='hide'><a href='' class='btn btn-primary btnRowEdit'><span class='fa fa-edit'></span></a> <a href='' class='btn btn-primary btnRowRemove'><span class='fa fa-trash-o'></span></a> </td>" +
		"</tr>";
	...
	var fetchLfiveStocks = function(item_id) {
		$.ajax({
			...
			type : 'POST',
			data : { 'item_id' : item_id , 'company_id': $('#cid').val(),'etype': 'fabricPurchase' ,'vrdate':$('#current_date').val()},
			dataType : 'JSON',
			success : function(data) {
	...
	var fetchLfiveRates = function(item_id) {
		...
		$.ajax({
			...
			type : 'POST',
			data : { 'item_id' : item_id , 'company_id': $('#cid').val(),'etype': "'purchase','fabricPurchase','fabricPurchase'",'crit':crit},
			dataType : 'JSON',
			success : function(data) {
	...
	var deleteVoucher = function(vrnoa) {
		...
		$.ajax({
			...
			type : 'POST',
			data : { 'vrnoa' : vrnoa , 'etype':'fabricPurchase','company_id':$('#cid').val() },
			dataType : 'JSON',
			success : function(data) {
