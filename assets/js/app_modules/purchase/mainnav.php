			...
			<div class="sub_panel">
				<div class="side_inner">
					...
					<ul>
						...
						';endif ;echo '						';
;echo '							<!-- <li class=\'report orderpartsreport\'> <a href="';echo base_url('index.php/report/orderParts');;echo '"><span class="side_icon"></span> Order Parts</a></li> -->
						';
;echo '						';
			...
			<div class="sub_panel">
				<div class="side_inner">
					...
					<ul>
						...
						';if ($vouchers['vendorcontract']['vendorcontract'] == 1): ;echo '							<li class=\'voucher vendorcontract\'> <a href="';echo base_url('index.php/vendorcontract');;echo '"><span class="side_icon"></span> Stitcher Contract</a> </li>
						';endif ;echo '
		...
		<li class=\'voucher-container\'>
			...
			<div class="sub_panel">
				<div class="side_inner">					
					...
					<ul>
						';
;echo '							<li class=\'voucher staff\'> <a href="';echo base_url('index.php/staff/add') ;echo '"><span class="side_icon ion-ios7-person-outline"></span> Staff</a> </li>
						';
;echo '						';
;echo '							<li class=\'voucher shift\'> <a href="';echo base_url('index.php/shift/add') ;echo '"><span class="side_icon ion-clock"></span> Shift</a> </li>
						';
;echo '						';
;echo '							<li class=\'voucher shift_group\'> <a href="';echo base_url('index.php/shift/addGroup') ;echo '"><span class="side_icon ion-arrow-swap"></span> Shift Group</a> </li>
						';
;echo '						';
;echo '							<li class=\'voucher allot_shift_group\'> <a href="';echo base_url('index.php/shift/allotGroup') ;echo '"><span class="side_icon ion-arrow-swap"></span> Allot Shift Group</a> </li>
						';
;echo '					</ul>
					<h4 class="panel_heading panel_heading_first">Other</h4>
					<ul>
						<li class=\'voucher level\'> <a href="';echo base_url('index.php/setting');;echo '"><span class="side_icon ion-levels"></span> Settings</a> </li>
					</ul>
					<h4 class="panel_heading panel_heading_first">Attandance</h4>
					';
;echo '						<ul>
							';
;echo '								<li class=\'voucher staff_attendance\'> <a href="';echo base_url('index.php/attendance/staff');;echo '"><span class="side_icon"></span> Staff Attendance</a> </li>
							';
;echo '							';
;echo '								<li class=\'voucher update_attendance_status\'> <a href="';echo base_url('index.php/attendance/update');;echo '"><span class="side_icon"></span> Update Attendance Status</a> </li>
							';
;echo '						</ul>
					';
;echo '					<h4 class="panel_heading panel_heading_first">HR</h4>
					<ul>
						';
;echo '							<li class=\'voucher overtime\'> <a href="';echo base_url('index.php/staff/overtime') ;echo '"><span class="side_icon ion-ios7-person-outline"></span> Overtime</a> </li>
						';
;echo '						';
;echo '							<!-- <li class=\'voucher cash_payment_receipt\'> <a href="';echo base_url('index.php/payment');;echo '"><span class="side_icon"></span> Salary Payment</a> </li> -->
						';
;echo '						';
;echo '							<li class=\'voucher penalty\'> <a href="';echo base_url('index.php/charge/penalty');;echo '"><span class="side_icon"></span> Penalty</a> </li>
						';
;echo '						';
;echo '							<li class=\'voucher loan\'> <a href="';echo base_url('index.php/loan');;echo '"><span class="side_icon"></span> Loan</a> </li>
						';
;echo '						';
;echo '							<li class=\'voucher advance\'> <a href="';echo base_url('index.php/payment/advance');;echo '"><span class="side_icon"></span> Advance</a> </li>
						';
;echo '						';
;echo '							<li class=\'voucher incentive\'> <a href="';echo base_url('index.php/payment/incentive');;echo '"><span class="side_icon"></span> Incentive</a> </li>
						';
;echo '						';
;echo '							<li class=\'voucher salary_sheet\'> <a href="';echo base_url('index.php/staff/salarySheet');;echo '"><span class="side_icon"></span> Salary Sheet</a> </li>
						';
;echo '					</ul>
...
;echo '						<h4 class="panel_heading panel_heading_first">Staff</h4>
						<ul>
							';
;echo '								<li class=\'report staff_status\'> <a href="';echo base_url('index.php/report/staffStatus');;echo '"> Status</a> </li>
							';
;echo '						</ul>
					';
;echo '					';
;echo '						<h4 class="panel_heading panel_heading_first">HR</h4>
						<ul>
							';
;echo '								<li class=\'report penalty_to_staff\'> <a href="';echo base_url('index.php/report/penalty');;echo '"><span class="side_icon ion-ios7-plus-empty"></span> Penalty to Staff</a> </li>
							';
;echo '							';
;echo '								<li class=\'report loan_to_staff\'> <a href="';echo base_url('index.php/report/loan');;echo '"><span class="side_icon ion-ios7-plus-empty"></span> Loan to Staff</a> </li>
							';
;echo '							';
;echo '								<li class=\'report advance_to_staff\'> <a href="';echo base_url('index.php/report/advance');;echo '"><span class="side_icon ion-ios7-plus-empty"></span> Advance to Staff</a> </li>
							';
;echo '							';
;echo '								<li class=\'report incentive_to_staff\'> <a href="';echo base_url('index.php/report/incentive');;echo '"><span class="side_icon ion-ios7-plus-empty"></span> Incentive to Staff</a> </li>
							';
;echo '							';
;echo '								<li class=\'report eobi_contribution\'> <a href="';echo base_url('index.php/report/eobiContribution');;echo '"><span class="side_icon ion-ios7-plus-empty"></span> Eobi Contribution</a> </li>
							';
;echo '							';
;echo '								<li class=\'report social_security_contribution\'> <a href="';echo base_url('index.php/report/socialSecurityContribution');;echo '"><span class="side_icon ion-ios7-plus-empty"></span> Social Security Contribution</a> </li>
							';
;echo '						</ul>
					';
;echo '					';
