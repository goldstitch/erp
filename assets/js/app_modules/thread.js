var Account = function() {
	...
	var getMaxId = function() {
		...
		$.ajax({
			...
			url : base_url + 'index.php/account/getMaxIdthd',
			type : 'POST',
			dataType : 'JSON',
	...
	var update = function () {
		$.ajax({
			url : base_url + 'index.php/account/update_thread',
			type : 'POST',
	...
	var fetch = function(id) {
		...
		$.ajax({
			url : base_url + 'index.php/account/fetch_thd',
			type : 'POST',
			data : { 'id' : id },
			dataType : 'JSON',
			success : function(data) {
	...
	var deleteVoucher = function(id) {
		...
		$.ajax({
			url : base_url + 'index.php/account/deletethd',
			type : 'POST',
			data : { 'id' : id },
			dataType : 'JSON',
			success : function(data) {
