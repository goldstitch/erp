var Purchase = function() {
	...
	var save = function(materialreturn) {

		$.ajax({
			url : base_url + 'index.php/materialreturn/save',
			type : 'POST',
			data : { 'stockmain' : materialreturn.stockmain, 'stockdetail' : materialreturn.stockdetail, 'vrnoa' : materialreturn.vrnoa,'voucher_type_hidden':$('#voucher_type_hidden').val(),'ledger' : materialreturn.ledger  },
			dataType : 'JSON',
			success : function(data) {
	...
	var fetch = function(vrnoa) {
		...
		$.ajax({
			...
			url : base_url + 'index.php/materialreturn/fetch',
			type : 'POST',
	...
	var getMaxVrno = function() {
		...
		$.ajax({
			...
			url : base_url + 'index.php/materialreturn/getMaxVrno',
			type : 'POST',
	...
	var getMaxVrnoa = function() {
		...
		$.ajax({
			...
			url : base_url + 'index.php/materialreturn/getMaxVrnoa',
			type : 'POST',
			data : {'company_id':$('#cid').val()},
			dataType : 'JSON',
			success : function(data) {
	...
	var fetchLfiveStocks = function(item_id) {
		$.ajax({
			...
			type : 'POST',
			data : { 'item_id' : item_id , 'company_id': $('#cid').val(),'etype': 'materialreturn' ,'vrdate':$('#current_date').val()},
			dataType : 'JSON',
			success : function(data) {
	...
	var fetchLfiveRates = function(item_id) {
		...
		$.ajax({
			...
			type : 'POST',
			data : { 'item_id' : item_id , 'company_id': $('#cid').val(),'etype': 'materialreturn','crit':crit},
			dataType : 'JSON',
			success : function(data) {
	...
	var getSaveObject = function() {
		...
		stockmain.etype = 'materialreturn';
	...
	var deleteVoucher = function(vrnoa) {
		...
		$.ajax({
			url : base_url + 'index.php/materialreturn/delete',
			type : 'POST',
			data : { 'vrnoa' : vrnoa,'company_id':$('#cid').val() },
			dataType : 'JSON',
			success : function(data) {
	...
	var calculateUpperTotal = function() {
		...
		var net = parseFloat(qty) * parseFloat(rate);
		$('#txtAmount').val(net);
		// $('#txtAmount').text(net);
	}
