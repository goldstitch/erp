...
var Transfer = function() {
	...
	var fetchReports = function (from, to,companyid,etype,uid) {
		...
		if (typeof dTable != 'undefined') {
		    ...
		    var save = function(stocknavigation) {
		    	...
		    	$.ajax({
		    		url : base_url + 'index.php/stocktransfer/save_receive',
		    		type : 'POST',
			...
			var setpost = function(vrnoa) {
				...
				$.ajax({
					url : base_url + 'index.php/stocktransfer/setposttransfer',
					type : 'POST',
					data : {'vrnoa':vrnoa},
					dataType : 'JSON',
					success : function(data) {
	...
	var post_chk = function(vrnoa) {
		$.ajax({
			...
			url : base_url + 'index.php/stocktransfer/postchktransfer',
			type : 'POST',
			data : {'vrnoa': vrnoa},
			dataType : 'JSON',
			success : function(data) {
		    ...
		    var fetch = function(vrnoa) {
		    	...
		    	$.ajax({
		    		...
		    		url : base_url + 'index.php/storetransfer/fetch_receive',
		    		type : 'POST',
			...
			var fetch_consume = function(vrnoa) {
		    	...
		    	$.ajax({
		    		...
		    		url : base_url + 'index.php/storetransfer/fetch_consume',
		    		type : 'POST',
		    		data : { 'vrnoa' : vrnoa, 'company_id': $('#cid').val() },
		    		dataType : 'JSON',
		    		success : function(data) {
		    ...
		    var getMaxVrno = function() {
		    	...
		    	$.ajax({
		    		...
		    		url : base_url + 'index.php/stocktransfer/getMaxVrno_receive',
		    		type : 'POST',
		    ...
		    var getMaxVrnoa = function() {
		    	...
		    	$.ajax({
		    		...
		    		url : base_url + 'index.php/stocktransfer/getMaxVrnoa_receive',
		    		type : 'POST',
		    		data : {'company_id':$('#cid').val()},
		    		dataType : 'JSON',
		    		success : function(data) {
