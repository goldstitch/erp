var Issuetovender = function() {
	...
	var fetchLfiveStocks = function(item_id) {
		$.ajax({
			...
			type : 'POST',
			data : { 'item_id' : item_id , 'company_id': $('#cid').val(),'etype': 'issuetovenders' ,'vrdate':$('#current_date').val()},
			dataType : 'JSON',
			success : function(data) {
	...
	var fetchLfiveRates = function(item_id) {
		...
		$.ajax({
			...
			type : 'POST',
			data : { 'item_id' : item_id , 'company_id': $('#cid').val(),'etype': 'issuetovenders','crit':crit,'vrdate':$('#current_date').val()},
			dataType : 'JSON',
			success : function(data) {
	...
	var fetchLvendor = function() {
		...
		$.ajax({
			...
			type : 'POST',
			data : {  'company_id': $('#cid').val(),'etype': 'issuetovenders','crit':crit,'vrdate':$('#current_date').val()},
			dataType : 'JSON',
			success : function(data) {
...
var populateDataGodowns = function(data) {
	...
	var save = function(purchase) {
		...
		$.ajax({
			url : base_url + 'index.php/issuetovender/save',
			type : 'POST',
	...
	var fetch = function(vrnoa) {
		...
		$.ajax({
			url : base_url + 'index.php/issuetovender/fetch',
			type : 'POST',
	...
	var getMaxVrno = function() {
		...
		$.ajax({
			...
			url : base_url + 'index.php/issuetovender/getMaxVrno',
			type : 'POST',
	...
	var getMaxVrnoa = function() {
		...
		$.ajax({
			...
			url : base_url + 'index.php/issuetovender/getMaxVrnoa',
			type : 'POST',
			data : {'company_id': $('#cid').val()},
			dataType : 'JSON',
			success : function(data) {
	...
	var getSaveObject = function() {
		...
		stockmain.etype = 'issuetovenders';
	...
	var deleteVoucher = function(vrnoa) {
		...
		$.ajax({
			url : base_url + 'index.php/issuetovender/delete',
			type : 'POST',
			data : { 'vrnoa' : vrnoa , 'etype':'issuetovenders','company_id':$('#cid').val() },
			dataType : 'JSON',
			success : function(data) {
	...
	return {
		...
		bindUI : function() {
			...
			$('#party_dropdownReceuive').select2();
