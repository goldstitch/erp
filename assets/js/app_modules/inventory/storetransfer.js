...
var Transfer = function() {
	...
	var fetchReports = function (from, to,companyid,etype,uid) {
		...
		if (typeof dTable != 'undefined') {
		    ...
		    var save = function(stocknavigation) {
		    	...
		    	$.ajax({
		    		url : base_url + 'index.php/storetransfer/save_issue',
		    		type : 'POST',
			...
			var setpost = function(vrnoa) {
				...
				$.ajax({
					url : base_url + 'index.php/storetransfer/setposttransfer',
					type : 'POST',
					data : {'vrnoa':vrnoa},
					dataType : 'JSON',
					success : function(data) {
			...
			var checkqty = function(item_id,deptfrom_id) {
				...
				$.ajax({
					url : base_url + 'index.php/storetransfer/chkqty',
					type : 'POST',
	...
	var post_chk = function(vrnoa) {
		$.ajax({
			...
			url : base_url + 'index.php/storetransfer/postchktransfer',
			type : 'POST',
			data : {'vrnoa': vrnoa},
			dataType : 'JSON',
			success : function(data) {
		    ...
		    var fetch = function(vrnoa) {
		    	...
		    	$.ajax({
		    		...
		    		url : base_url + 'index.php/storetransfer/fetch_issue',
		    		type : 'POST',
		    ...
		    var getMaxVrno = function() {
		    	...
		    	$.ajax({
		    		...
		    		url : base_url + 'index.php/storetransfer/getMaxVrno_issue',
		    		type : 'POST',
		    ...
		    var getMaxVrnoa = function() {
		    	...
		    	$.ajax({
		    		...
		    		url : base_url + 'index.php/storetransfer/getMaxVrnoa_issue',
		    		type : 'POST',
		    		data : {'company_id':$('#cid').val()},
		    		dataType : 'JSON',
		    		success : function(data) {
		    ...
		    var deleteVoucher = function(vrnoa) {
		    	...
		    	$.ajax({
		    		url : base_url + 'index.php/storetransfer/delete',
		    		type : 'POST',
		    		data : { 'vrnoa' : vrnoa, 'company_id': $('#cid').val() },
		    		dataType : 'JSON',
		    		success : function(data) {
		...
		bindUI : function() {
			...
			$('#btnAdd').on('click', function(e) {
				...
				//	appendToTable('1', item_desc, item_id, deptfrom, fromdept_id, uom, qty, weight, deptto, todept_id);
                    var id;
					id =($('#cpv').is(':checked') === true) ? 'cpv' : 'crv';
				    if(id=='cpv')
					{
						$('.Lstocks_table2').find('tbody tr').each(function( index, elem ) {
						
							var m_qty =qty*$.trim($(this).closest('tr').find('td.2').text());
							issueStock += parseFloat(m_qty);
						});
						
						if(issueStock>totalStock)
						{
						...
						else
						{
							$('.Lstocks_table2').find('tbody tr').each(function( index, elem ) {
								...
								appendToTable('1', material, item_id_, deptfrom, fromdept_id, uom, parseFloat(m_qty).toFixed(2), weight, deptto, todept_id );
