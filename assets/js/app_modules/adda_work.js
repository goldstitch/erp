var Cutting = function() {
	...
	var getMaxIdcut = function() {
		...
		$.ajax({
			...
			url : base_url + 'index.php/account/getMaxIdaddawork',
			type : 'POST',
			dataType : 'JSON',
	...
	var update = function () {
		$.ajax({
			url : base_url + 'index.php/account/update_addawork',
			type : 'POST',
	...
	var fetch = function(id) {
		...
		$.ajax({
			url : base_url + 'index.php/account/fetch_addawork',
			type : 'POST',
			data : { 'id' :id },
			dataType : 'JSON',
			success : function(data) {
	...
	var deleteVoucher = function() {
		...
		$.ajax({
			url : base_url + 'index.php/account/delete_addawork',
			type : 'POST',
