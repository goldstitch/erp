var Color = function() {
	...
	var save = function( color ) {
		...
		$.ajax({
			url : base_url + 'index.php/currency/saveCurrencey',
			type : 'POST',
			data : { 'color' : color },
			dataType : 'JSON',
	...
	var fetch = function(id) {
		...
		$.ajax({
			url : base_url + 'index.php/currency/fetchCurrencey',
			type : 'POST',
			data : { 'id' : id },
			dataType : 'JSON',
			success : function(data) {
	...
	var populateData = function(data) {
		...
		$.each(data, function(index, elem){
			...
			$('#txtExchangeRate').val(elem.exchange_rate);
			$('#user_dropdown').val(elem.uid);
			$('#txtCurrencySymbol').val(elem.cur_symbol);
	...
	var getMaxId = function() {
		...
		$.ajax({
			url : base_url + 'index.php/currency/getMaxCurrenceyId',
			type : 'POST',
			dataType : 'JSON',
			success : function(data) {
	...
	var getSaveObject = function() {
		...
		obj.exchange_rate = $.trim($('#txtExchangeRate').val());
		obj.uid = $.trim($('#uid').val());
		obj.cur_symbol = $.trim($('#txtCurrencySymbol').val());
