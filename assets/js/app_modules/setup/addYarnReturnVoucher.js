var YarnIssue = function() {
	...
	var save = function( yarn_issue ) {
		...
		$.ajax({
			...
			data : {'etype':'yarnreturn', 'stockmain' : yarn_issue.stockmain, 'stockdetail' : yarn_issue.stockdetail, 'vrnoa' : yarn_issue.vrnoa ,'voucher_type_hidden':$('#vouchertypehidden').val() },
	...
	var fetch = function(vrnoa) {
		...
		$.ajax({
			...
			type : 'POST',
			data : { 'vrnoa' : vrnoa,'etype':'yarnreturn','company_id':$('#cid').val() },
			dataType : 'JSON',
			success : function(data) {
	...
	var getMaxId = function() {
		...
		$.ajax({
			...
			type : 'POST',
			data : {'company_id': $('#cid').val() ,'etype':'yarnreturn'},
