var Phasetype = function() {
	...
	var save = function( phasetype ) {

		$.ajax({
			url : base_url + 'index.php/phasetype/savePhaseType',
			type : 'POST',
			...
			success : function(data) {
				...
				if (data.error === 'false') {
					alert('An internal error occured while saving phasetype. Please try again.');
				} else {
					alert('Phasetype saved successfully.');
	...
	var fetch = function(id) {
		...
		$.ajax({
			url : base_url + 'index.php/phasetype/fetchPhaseType',
			type : 'POST',
			data : { 'id' : id },
			dataType : 'JSON',
			success : function(data) {
	...
	var getMaxId = function() {
		...
		$.ajax({
			url : base_url + 'index.php/phasetype/getMaxPhaseTypeId',
			type : 'POST',
			dataType : 'JSON',
			success : function(data) {
