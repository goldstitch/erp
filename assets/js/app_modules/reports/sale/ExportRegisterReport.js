 Purchase = function() {
    ...
    var fetchVouchers = function (from, to, what, type,etype,field,crit,orderBy,groupBy,name) {
        ...
        $.ajax({
                url: base_url + "index.php/report/fetchPurchaseReportData_export",//fetchSaleProductionData
                        ...
                        if (type == "detailed") {
                            ...
                            var prevVoucherMatch = "";
                                ...
                                $.each(result, function (index, elem) {
                                    ...
                                    obj.NAME = (elem.pi) ? elem.pi : "-";
                                    obj.VRDATE = (elem.vrdate) ? elem.vrdate.substring(0,10) : "-";
                                    obj.INVDATE = elem.inv_date;
                                    obj.PINO = elem.pi;
                                    obj.ADVANCEPAYMENT = elem.advance;
                                    // obj.ADVANCE = elem.advance;
                                    // obj.ADVANCE = elem.advance;
                                    obj.INVNO = elem.inv_no;
                                    obj.EFORMNO = elem.eform;
                                    obj.CTNNO = elem.ctn;
                                    obj.INVVALUE = elem.value_amount;
                                    obj.DELIVERDATE = elem.delivery_date;
                                    obj.CONTAINERNO = elem.container_no;
                                    obj.BLNO = elem.bl_no;
                                    obj.ROUTINGBANK = elem.routing_bank;
                                    obj.PAYMENTSHIPPING = elem.payment_doc;
                                    obj.DHLNO = elem.dhl_no;
                                    obj.GDDATE = elem.gd_date;
                                    obj.RECEIVEDPAYMENT = elem.received_payment;
                                    obj.RECEIVEDDATE = elem.received_date;
                                    obj.TRANSPORT = elem.transport;
                                    obj.SEAFREIGHT = elem.sea_freight;
                                    obj.FORWARDEN = elem.forwader;
                                    obj.CLEARINGAGENT = elem.clrearing_agent;
                                    obj.REBATEDOC = elem.rebate_doc;
                                    obj.SALETAXDOC = elem.saletax_doc;
                                    obj.YARN = elem.yarn;
                            ...
                            $( result ).each( function (index, elem ){
                                ...
                                var obj = { };
                                obj.SERIAL = saleRows.find('tr').length+1;
                                obj.ADVANCEPAYMENT = (elem.advance) ? Math.abs(elem.advance) : "-";
                                obj.PAYMENTSHIPPING = (elem.payment_doc) ? Math.abs(elem.payment_doc) : "-";
                                obj.RECEIVEDPAYMENT = (elem.received_payment) ? (elem.received_payment) : "-";
                                obj.TRANSPORT = (elem.transport) ? elem.transport : "-";
    ...
    var Print_Voucher = function( ) {
        ...
        // My New 
            ...
            var name = '';
            if (what === 'voucher') {
                field =   'export_register.VRNOA';
                orderBy = 'export_register.VRNOA';
                groupBy = 'export_register.VRNOA';
                name    = 'party.NAME';
            }else if (what === 'pi') {
                field =   'party.NAME';
                orderBy = 'party.NAME';
                ...
                field =   'date(export_register.VRDATE)';
                orderBy = 'date(export_register.VRDATE)';
                groupBy = 'date(export_register.VRDATE)';
                name = 'party.NAME';
            }else if (what === 'year') {
                field =   'year(vrdate)';
                orderBy = 'year(vrdate)';
        ...
        bindUI : function() {
            ...
            $('#btnSearch').on('click', function(e) {
                ...
                if (what === 'voucher') {
                    ...
                    orderBy = 'export_register.vrnoa';
                    groupBy = 'export_register.vrnoa';
                    name    = 'export_register.pi as name';
                }else if (what === 'pi') {
                    field =   'export_register.pi';
                    orderBy = 'export_register.pi';
                    groupBy = 'export_register.pi';
                    name    = 'export_register.pi';
                }else if (what === 'invoice') {
                    field =   'export_register.inv_no';
                    orderBy = 'export_register.inv_no';
                    groupBy = 'export_register.inv_no';
                    name = ' export_register.inv_no AS name';
                }else if (what === 'bl') {
                    field =   'export_register.bl_no';
                    orderBy = 'export_register.bl_no';
                    groupBy = 'export_register.bl_no';
                    if (type === 'detailed') {
                        name = 'export_register.pi as name';
                    }else{
                        name = 'export_register.bl_no as name';
                    }
