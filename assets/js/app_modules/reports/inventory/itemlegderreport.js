 itemledger = function() {
 	...
 	var fetchReport = function (from, to, item_id,pid) {
        ...
        $.ajax({
            ...
            data: { 'from' : from, 'to' : to, 'item_id' : item_id , 'company_id': crit,'pid':pid },
            type: 'POST',
            dataType: 'JSON',
            beforeSend: function () {
                    ...
                    if (result.length != 0) {
                        ...
                        $.each(result, function (index, elem) {
                            ...
                            if ( elem.etype.toLowerCase() == 'sale' ) {
                                ...
                                obj.vrnoa = '<a href="' + base_url + 'index.php/productionVoucher?vrnoa=' + elem.vrnoa + '">' + elem.vrnoa + '-' + elem.etype + '</a>';
                                ...
                                obj.vrnoa = '<a href="' + base_url + 'index.php/issuetovender?vrnoa=' + elem.vrnoa + '">' + elem.vrnoa + '-issuetovender'  + '</a>';
                                ...
                                obj.vrnoa = '<a href="' + base_url + 'index.php/receivefromvender/VenderStockTransfer?vrnoa=' + elem.vrnoa + '">' + elem.vrnoa + '-transfer'  + '</a>';
...
fetchRequestedLedger : function () {
    ...
    if ( !isNaN( item_id ) ) {
        $('#item_dropdown').val(item_id);
                // itemLedger.fetchItemLedger($('#from_date').val(), $('#to_date').val(), item_id );
                // itemledger.fetchItemOpeningStock($('#from_date').val(), item_id , 0);
                // fetchReport($('#from_date').val(), $('#to_date').val(), item_id, 0);
        ...
        fetchItemOpeningStock : function ( startDate, item_id,pid ) {
            ...
            $.ajax({
                ...
                type: 'POST',
                dataType: 'JSON',
                data: { 'to': startDate, 'item_id' : item_id, 'company_id' : crit ,'pid':pid },
