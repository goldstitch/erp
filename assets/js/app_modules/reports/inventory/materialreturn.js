var Purchase = function() {
 	...
 	var fetchVouchers = function (from, to, what, type) {
		...
		$.ajax({
                url: base_url + "index.php/report/fetchMaterialReturnData",
                ...
                success: function (result) {
                    ...
                    if (result.length !== []) {
                        ...
                        var th;
                        if ((what == "voucher" || what == "person" || what == "location" || what == "item" || what == "date") && type == "detailed"){
                        ...
                        if (what == "voucher" && type == "detailed") {
                            ...
                            $( result ).each( function (index, elem ){
                                ...
                                var obj = { };
                                obj.SERIAL = index + 1;
                                obj.NAME = (elem.NAME) ? elem.NAME.substr(0, 10) : "Not Available";
                                obj.QTY = (elem.QTY) ? Math.abs(elem.QTY) : "Not Available";
                                obj.RATE = (elem.RATE) ? elem.RATE : "Not Available";
                                obj.AMOUNT = (elem.AMOUNT) ? elem.AMOUNT : "Not Available";
    ...
    var sendMail = function() {
        ...
        _data.type = 'Material Return Report';
