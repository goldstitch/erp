	...
	<head>
		...
		<style>
			 * { margin: 0; padding: 0; font-family: tahoma !important; }
			 ...
			 .field2 { font-size:10px !important; font-weight: bold !important; display: inline-block !important; width: 0px !important; } 
						...
						<div class="span12 header">
							<div class="header-field">
								<div class="block pull-left inv-leftblock" style="width:250px !important; display:inline !important;">
									...
									<p><span class="field">Date:</span><span class="fieldvalue inv-date">';echo substr($vrdetail[0]['vrdate'],0,10);;echo '</span></p>
							...
							<div class="header-terms">
								<p><span class="field">Payment Terms:</span><span class="fieldvalue cust-mobile padd-left">';echo $vrdetail[0]['payment_term'];;echo '</span></p>
								<p><span class="field">Delivery Terms:</span><span class="fieldvalue cust-mobile padd-left">';echo $vrdetail[0]['delivery_term'];;echo '</span></p>
							</div>
...
;echo '									<tr  class="item-row">
									   ...
									   <td class=\'text-right\'>';echo ($row['uom']=='dozen'?number_format(abs($row['qty']/12),0):'');;echo '</td>
...
endforeach;echo '							</tbody>
							<tfoot>
								<tr class="foot-comments">
									...
									<td class="subtotalend bold-td text-right" colspan="2">';echo number_format($netQty,2);;echo '</td>
									...
									<td class="subtotalend bold-td text-right" colspan="2">';echo number_format($netAmount,2);;echo '</td>
								</tr>
								
								';if(intval($vrdetail[0]['discount'])!=0){;echo '								<tr>
									<td class="subtotal bold-td text-right discount-td " colspan="6">Discount:</td>
								...
								';};echo '								';if(intval($vrdetail[0]['expense'])!=0){;echo '								<tr>
									<td class="subtotal bold-td text-right discount-td " colspan="6">Expense:</td>
								...
								';};echo '								';if(intval($vrdetail[0]['tax'])!=0){;echo '								<tr>
									<td class="subtotal bold-td text-right discount-td " colspan="6">Tax:</td>
								...
								';};echo '								';if(!(intval($vrdetail[0]['tax'])==0 &&intval($vrdetail[0]['discount'])==0 &&intval($vrdetail[0]['expense'])==0 &&intval($vrdetail[0]['paid'])==0) ){;echo '								<tr>
									<td class="subtotal bold-td text-right discount-td " colspan="6">NetAmount:</td>
					...
					<div class="row-fluid">
						<p>
							<span class="footer_company">User:';echo $user;;echo '</span><br>
