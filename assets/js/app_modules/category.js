var Cutting = function() {
	...
	var getMaxIdcut = function() {
		...
		$.ajax({
			...
			url : base_url + 'index.php/account/getMaxId_category',
			type : 'POST',
			dataType : 'JSON',
	...
	var save = function () {
		$.ajax({
			url : base_url + 'index.php/account/save_category',
			type : 'POST',
	...
	var update = function () {
		$.ajax({
			url : base_url + 'index.php/account/update_category',
			type : 'POST',
			data : { 'id':$('#txtAccountIdHidden').val(),'name' :$('#txtName').val() },
			dataType : 'JSON',
			success : function(data) {
	...
	var fetch = function(id) {
		...
		$.ajax({
			url : base_url + 'index.php/account/fetch_category',
			type : 'POST',
			data : { 'id' :id },
			dataType : 'JSON',
			success : function(data) {
	...
	var deleteVoucher = function() {
		...
		$.ajax({
			url : base_url + 'index.php/account/delete_category',
			type : 'POST',
