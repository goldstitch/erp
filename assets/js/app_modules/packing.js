var Account = function() {
	...
	var getMaxId = function() {
		...
		$.ajax({
			...
			url : base_url + 'index.php/account/getMaxIdpack',
			type : 'POST',
			dataType : 'JSON',
	...
	var update = function () {
		$.ajax({
			url : base_url + 'index.php/account/update_pack',
			type : 'POST',
	...
	var fetch = function(id) {
		...
		$.ajax({
			url : base_url + 'index.php/account/fetch_pack',
			type : 'POST',
			data : { 'id' : id },
			dataType : 'JSON',
			success : function(data) {
	...
	var deleteVoucher = function() {
		...
		$.ajax({
			url : base_url + 'index.php/account/deletepack',
			type : 'POST',
